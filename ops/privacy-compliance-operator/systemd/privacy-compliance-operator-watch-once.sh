...
HTTP_STATUS="$(
  curl --silent --show-error --max-time 25 --retry 2 --retry-delay 2 \
    ...
    --data '{"action":"watch_once","platform":"ios","environment_mode":"production","scheduler":"systemd_timer","operator_id":"privacy_compliance_operator","source":"'"${SOURCE}"'","moneyMoved":false,"userRightsChanged":false,"highRiskExecuted":false}'
)"
