export const MODEL_STATEMENTS = Object.freeze({
  recoverModelReservation: Object.freeze({
    arity: 4,
    text: `select public.cognitive_model_router_recover_expired(
      $1::uuid,$2::integer,$3::text,$4::text
    ) as result`,
  }),
  reserveModelInvocation: Object.freeze({
    arity: 21,
    text: `select public.cognitive_model_router_reserve(
      $1::uuid,$2::uuid,$3::uuid,$4::public.cognitive_platform,
      $5::public.cognitive_environment,$6::text,$7::text,$8::text,$9::text,
  ...
  settleModelInvocation: Object.freeze({
    arity: 13,
    text: `select public.cognitive_model_router_settle(
