export const RESEARCH_BROKER_STATEMENTS = Object.freeze({
  detectResearchContradiction: Object.freeze({
    arity: 8,
    text: `select cognitive_runtime.cognitive_record_public_research_contradiction_detection(
  ...
  expirePublicResearch: Object.freeze({
    arity: 6,
    text: `select cognitive_runtime.cognitive_expire_public_research_maintenance(
      $1::uuid,$2::uuid,$3::text,
      $4::text,$5::integer,$6::text
    ) as result`,
  }),
  ...
  recordPublicResearchSource: Object.freeze({
    arity: 21,
    text: `select cognitive_runtime.cognitive_record_public_research_source_v2(
      $1::uuid,$2::uuid,$3::text,
