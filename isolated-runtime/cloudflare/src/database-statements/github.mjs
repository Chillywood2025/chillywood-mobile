export const GITHUB_STATEMENTS = Object.freeze({
  acceptGithubToolResult: Object.freeze({
    arity: 12,
    text: `select public.cognitive_accept_github_draft_pr_tool_result(
  ...
  consumeGithubCapability: Object.freeze({
    arity: 37,
    text: `select public.cognitive_consume_github_draft_pr_capability(
      $1::text,$2::text,$3::text,$4::text,$5::uuid,$6::uuid,$7::text,
      $8::text,$9::public.cognitive_platform,
      $10::public.cognitive_environment,$11::text,$12::text,$13::text,
  ...
  recordGithubProviderReadback: Object.freeze({
    arity: 9,
    text: `select public.cognitive_record_github_draft_pr_provider_readback(
      $1::uuid,$2::uuid,$3::public.cognitive_platform,
      $4::public.cognitive_environment,$5::text,$6::text,$7::text,
