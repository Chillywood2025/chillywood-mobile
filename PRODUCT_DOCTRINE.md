...
- Admin finance foundation may show safe row counts for future finance ledger, payout ledger, payout-provider foundation, network billing, sponsor deals, and fraud holds now that the schema is applied and readable to platform roles. Counts are not live money totals and must not imply payout availability, payout-account readiness, invoice execution, sponsor checkout, payout split execution, fraud enforcement, provider reconciliation, or creator-facing balances.
