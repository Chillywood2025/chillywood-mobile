...
exports.HEIF = {
    ...
    calculate(input) {
        ...
        const iprpBox = metaBox && metaBox.size >= 12 && (0, utils_1.findBox)(input, 'iprp', metaBox.offset + 12, metaEnd);
        const iprpEnd = iprpBox && iprpBox.offset + iprpBox.size;
        const ipcoBox = iprpBox && iprpBox.size >= 8 && (0, utils_1.findBox)(input, 'ipco', iprpBox.offset + 8, iprpEnd);
        const ipcoEnd = ipcoBox && ipcoBox.offset + ipcoBox.size;
        const ispeBox = ipcoBox && ipcoBox.size >= 8 && (0, utils_1.findBox)(input, 'ispe', ipcoBox.offset + 8, ipcoEnd);
