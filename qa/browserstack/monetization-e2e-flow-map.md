...
- Watch-Party Seat Pass pre: ticket fixture and target exist, `grants_livekit_publish=false`, `grants_host_authority=false`. Post: ticket success receipt, waiting room/Party Room reached, no LiveKit publish/host authority, no unrelated unlocks, payout authority false.
...
Watch-Party Live media authority is not part of the money proof. Seat Pass proof can be one-device to the Party Waiting Room/Room gate. Multi-device room authority proof remains separate.
