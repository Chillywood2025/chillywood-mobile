...
- Main SHA observed at this assurance checkpoint: `331ccc77543ad56e911a81b90c5ce7164f6efb15`.
- Latest merged implementation: PR #206, `78ea29c15f61aa235417cced13b53eb555fb7e3e`; merge `331ccc77543ad56e911a81b90c5ce7164f6efb15`.
- Structured implementation binding: feature `codex-security-scan-reliability-s0`, PR #206, immutable `47091a7b2a30f9f15f57c581835fd75794defc71` / `a40acd0b97ab9a10096c88074a72c741bd3d90ac`, synchronized `78ea29c15f61aa235417cced13b53eb555fb7e3e` / `d8d14d9056e918de7544f98d07ab2259b071cf3b`, phase `COMPLETE`, execution `S0_COMPLETE_LAUNCH_CRITICAL_MIC_CORRECTION_NEXT_D2A_FROZEN`.
- Proof-tier statuses: `T0_REQUIREMENT`=`REQUIREMENTS_CLEAR`, `T1_SOURCE`=`SOURCE_CLEAR`, `T2_MODEL`=`MODEL_CLEAR`, `T3_INTEGRATION`=`INTEGRATION_CLEAR`, `T4_NATIVE_PROVIDER`=`NOT_APPLICABLE`, `T5_SIGNED_ARTIFACT`=`NOT_APPLICABLE`, `T6_INSTALLED_PHYSICAL`=`NOT_APPLICABLE`, `T7_PUBLIC_CANARY`=`NOT_APPLICABLE`.
...
- Current freshness claims: `repository-source-livekit-mic-correction-final` (REPOSITORY_SOURCE, expires `2026-08-12T06:22:00Z`), `repository-source-s0-exact-closure-reuse-final` (REPOSITORY_SOURCE, expires `2026-08-12T04:34:00Z`).
...
- Document rendered at `2026-08-11T06:52:00Z`; document deadline `2026-08-12T06:22:00Z`. This deadline authorizes no claim. Derived live provider readback: false.
