...
- Current freshness claims: `repository-source-a1-assurance-control` (REPOSITORY_SOURCE, expires `2026-08-10T18:05:08Z`), `repository-source-d2a-microphone-correction-merge-closeout` (REPOSITORY_SOURCE, expires `2026-08-10T18:05:08Z`).
...
- Document rendered at `2026-08-09T18:05:08Z`; document deadline `2026-08-10T18:05:08Z`. This deadline authorizes no claim. Derived live provider readback: false.

## Open implementation PRs

- PR #201 at `f1ea11e1588aef1650e05db1ee9c44fe600f81e1`: open-draft-current; A1 immutable source frozen; only the canonical three-file current-truth binding commit follows.
