...
- Structured implementation binding: feature `codex-security-scan-reliability-s0`, PR #206, immutable `5d9d9e5d71a699fa3acba8629eba14d3b3b9de66` / `a45dcc92fe3f2aa22f562c7328a0896283ceb303`, synchronized `5d9d9e5d71a699fa3acba8629eba14d3b3b9de66` / `a45dcc92fe3f2aa22f562c7328a0896283ceb303`, phase `FORMAL_REVIEW`, execution `CODEX_SECURITY_SCAN_RELIABILITY_S0_BOOTSTRAP`.
...
- PR #206 at `5d9d9e5d71a699fa3acba8629eba14d3b3b9de66`: open-draft-current; S0 final telemetry-safe scope-governed evidence anchor frozen and Owner-authorized; only this exact three-file binding follows before independent review.
