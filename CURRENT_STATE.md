...
- Structured implementation binding: feature `chilly-chat-call-lifecycle`, PR #210, immutable `fdf26bb872905e77267012121e8d0feb44aad64d` / `ad92b303be809328efda0727ddf5d16f8f7c7f08`, synchronized `fdf26bb872905e77267012121e8d0feb44aad64d` / `ad92b303be809328efda0727ddf5d16f8f7c7f08`, phase `FORMAL_REVIEW`, execution `LIVEKIT_MIC_POST_MERGE_CORRECTION_REVIEW_D2A_FROZEN`.
...
- Current freshness claims: `repository-source-livekit-mic-post-merge-correction-final` (REPOSITORY_SOURCE, expires `2026-08-12T07:20:00Z`), `repository-source-s0-exact-closure-reuse-final` (REPOSITORY_SOURCE, expires `2026-08-12T04:34:00Z`).
...
- Document rendered at `2026-08-11T07:23:00Z`; document deadline `2026-08-12T07:20:00Z`. This deadline authorizes no claim. Derived live provider readback: false.

## Open implementation PRs

- PR #210 at `fdf26bb872905e77267012121e8d0feb44aad64d`: open-draft-current; complete-exact-review-ci-and-protected-merge.
