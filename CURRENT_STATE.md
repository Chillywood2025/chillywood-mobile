...
- Current freshness claims: `repository-source-d2a-legacy-webrtc-correction-admission` (REPOSITORY_SOURCE, expires `2026-08-12T15:38:07Z`), `repository-source-s0-exact-closure-reuse-final` (REPOSITORY_SOURCE, expires `2026-08-12T04:34:00Z`).
...
- Document rendered at `2026-08-11T15:38:07Z`; document deadline `2026-08-12T15:38:07Z`. This deadline authorizes no claim. Derived live provider readback: false.

## Open implementation PRs

- PR #214 at `a5f0ff45131041e5d0a554c26311a64e7b72c5bc`: open-draft-current; implementation.
