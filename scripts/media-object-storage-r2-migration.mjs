...
const handleBackendMode = async () => {
  const actionByMode = {
    ...
    classify: "classify_stale_refs",
    "classify-stale": "classify_stale_refs",
    "resolution-plan": "resolve_stale_refs_dry_run",
    "resolve-stale-dry-run": "resolve_stale_refs_dry_run",
    "apply-resolutions": "apply_stale_ref_resolutions",
    "apply-stale-resolutions": "apply_stale_ref_resolutions",
