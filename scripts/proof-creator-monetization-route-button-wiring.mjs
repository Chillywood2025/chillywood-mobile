...
const flowChecks = [
  ...
  },
  {
    ...
    viewerChecks: [
      ...
      ["viewer sandbox success copy avoids payout language", creatorTips, "message: \"Sandbox tip complete.\""],
  ...
  },
  {
    ...
    viewerChecks: [
      ...
      ["viewer route keeps clear subscription CTA", channelSubscriptionRoute, "Start Channel Subscription"],
      ["viewer route has simple unavailable copy", channelSubscriptionRoute, "Channel Subscription purchases are temporarily unavailable while setup is being finalized."],
      ...
      ["viewer canceled state is clear", channelSubscriptions, "Channel Subscription was canceled. Nothing changed."],
