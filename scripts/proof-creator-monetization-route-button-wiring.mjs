...
[
  ...
  ["Watch-Party Ticket actual tappable CTA testID", "money-feature-watch_party_ticket-cta"],
  ...
  ["Money Center accordion Ways to Earn uses suffixed testIDs", 'renderWaysToEarnContent("money-center-ways-to-earn-accordion-panel", "-accordion")'],
  ["Money Center manager opens in bottom sheet", "money-manager-sheet"],
