...
[
  ...
  ["Money Center scroll focus captures stable start", "const startingScrollY = studioScrollYRef.current"],
  ["Money Center scroll focus moves forward from stable start", "startingScrollY + 920"],
  ["Money Center Ways to Earn minimum target", "id === \"ways_to_earn\" ? 3600 : 2600"],
  ...
  ["Money Center manager panel anchor", "moneyManagerOffsetRef"],
  ["Money Center manager focus helper", "focusActiveMoneyManagerPanel"],
  ["Money Center feature manager scroll focus", "focusActiveMoneyManagerPanel();"],
  ["Money Center manager panel layout anchor", "testID={`money-manager-${activeMoneyManageTarget}`}"],
