...
export function renderNextTask(record) {
  const nextActions = record.preAdmissionEngineeringSeedCapability?.status === "ACTIVE" && record.engineeringDoctrine?.taskLeaseState === "NO_ACTIVE_TASK"
