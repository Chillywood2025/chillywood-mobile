...
assert.equal(manifest.releaseStatus, "internal_build_available_physical_upgrade_pending");
...
assert.equal(artifactEvidence.inPlaceUpgradeState, "device_not_available");
...
assert.equal(playEvidence.playDeliveredUpgradeState, "device_not_available");
assert.equal(playEvidence.sessionPreservationState, "not_observed");
assert.equal(playEvidence.settingsPreservationState, "not_observed");
assert.equal(playEvidence.physicalNativeModuleState, "not_observed");
assert.equal(playEvidence.physicalHeicState, "not_observed");
