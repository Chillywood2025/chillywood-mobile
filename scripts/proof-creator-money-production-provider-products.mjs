...
const products = [
  ...
  },
  {
    ...
    productType: "one_time_consumable",
    displayName: "Watch-Party Seat Pass",
    shortDescription: "Unlock access to one paid Watch-Party room.",
    launchPriceUsd: "$0.99",
    launchRegion: "United States only first",
...
const summary = {
  ...
  existingProductRecords: ["Tips draft", "Paid Video draft", "Watch-Party Seat Pass draft", "VIP draft", "Event Pass draft", "Channel Subscription product record"],
  readyProducts: ["Tips draft provider records", "Paid Video draft provider records", "Watch-Party Seat Pass draft provider records", "VIP draft provider records", "Event Pass draft provider records"],
