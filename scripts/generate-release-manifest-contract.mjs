...
const ios = readJson("config/release/ios-internal-v2.json");
...
const iosContract = {
  ...
  releaseLane: ios.releaseLane,
  environment: ios.environment,
  buildProfile: ios.buildProfile,
  ...
  binarySourceCommit: ios.expectedBinarySourceCommit,
  currentOtaSourceCommit: ios.currentOtaSourceCommit,
  currentOtaUpdateGroup: ios.currentOtaUpdateGroup,
  binarySha256: ios.binarySha256,
  easBuildId: ios.easBuildId,
  appStoreConnectBuildId: ios.appStoreConnectBuildId,
  buildStatus: ios.buildStatus,
...
const output = `// Generated from config/release/ios-internal-v2.json and config/release/android-production.json.\n// Run npm run generate:release-manifest-contract; CI fails when these values drift.\nexport const IOS_INTERNAL_V2_RELEASE_MANIFEST = ${freeze(iosContract)};\n\nexport const ANDROID_PRODUCTION_RELEASE_MANIFEST = ${freeze(androidContract)};\n`;
