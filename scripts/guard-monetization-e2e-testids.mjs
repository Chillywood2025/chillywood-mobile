...
[
  ...
  [files.channel, "platform-support-tip-button", "creator tip offer selector"],
  [files.channel, "platform-support-subscribe-button", "creator subscription offer selector"],
  [files.channel, "platform-support-vip-button", "creator VIP offer selector"],
  [files.channel, "platform-support-ticket-button", "exact Party Room offer selector"],
