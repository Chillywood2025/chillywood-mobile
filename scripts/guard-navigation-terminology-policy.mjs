...
assertIncludes(libraryTab, "Your backed saved titles, watch progress, and followed Platforms live here.", "Library backed scope copy");
assertIncludes(libraryTab, "Replays, events, and clips stay hidden until saved rows exist.", "no fake Library sections");
...
assertIncludes(explore, "Public discovery stays backed by existing title, Platform, creator video, Originals, event, and replay read models.", "Explore backed scope copy");
...
assertIncludes(explore, "No public replay rows yet", "Explore honest replay empty state");
