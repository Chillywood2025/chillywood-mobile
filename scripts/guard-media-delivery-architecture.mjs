...
assertIncludes(mediaWorkerCliChecklist, "production creator-video playback remains signed-origin fallback by default", "media worker CLI checklist production fallback");
