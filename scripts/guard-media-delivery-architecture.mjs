...
assertIncludes(currentState, "source support is now wired for audited public-safe `media_renditions` rows", "current state trusted audited CDN eligibility");
...
assertIncludes(nextTask, "Next real media milestone is explicit owner approval for an installed playback/resolver bridge proof or production worker deployment design, not production playback migration.", "next task worker activation gate next step");
