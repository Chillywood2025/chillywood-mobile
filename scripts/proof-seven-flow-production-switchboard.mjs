...
const flows = [
  {
    ...
    refundPolicy: "No standard Chi'llywood refund. Canceling stops future renewal; authoritative store/provider/legal/fraud/duplicate/unauthorized reversals reconcile separately.",
  ...
  },
  {
    ...
    refundPolicy: "Final and non-refundable through Chi'llywood; authoritative fraud, duplicate, unauthorized, chargeback, provider, and legal reversals reconcile separately.",
    disputePolicy: "Provider/store dispute handled externally; app access unaffected.",
    creatorExpectation: "Tips unlock nothing; verified earnings use a seven-day hold and reserve, but production payouts are not live.",
  ...
  },
  {
    ...
    creatorExpectation: "Verified direct sales use a seven-day hold and reserve; subscription-included playback creates no extra economics; production payouts remain off.",
  ...
  },
  {
    ...
    sandboxBehavior: "Sandbox Seat Pass grant is exact Party Room target only; no LiveKit authority.",
    productionReadiness: "Blocked until production product mapping/provider approval and owner activation.",
    ...
    creatorExpectation: "Seat Pass earnings require successful canonical room completion plus 48 hours and reserve; production payouts remain off.",
    rollback: "Set watch_party_tickets_enabled off; stop Seat Pass creation; keep existing access stable unless policy revokes.",
  },
  {
    ...
    sandboxBehavior: "Sandbox subscription creates exact-creator subscriber access and read-time access to that creator's ordinary Paid Videos while active, without per-video grants or economics.",
    ...
    refundPolicy: "Canceling stops future renewal. No standard prorated refund for a started paid period; access failure may enter remedy review and authoritative reversals reconcile separately.",
    disputePolicy: "Use provider period, subscription row, access grant, and route readback.",
    creatorExpectation: "Each verified billing period uses a seven-day hold and reserve; included Paid Video views create no extra economics; production payouts remain off.",
  ...
  },
  {
    ...
    sandboxBehavior: "Sandbox VIP creates exactly 30 days of exact-creator VIP Area and VIP-only shelf access from verified activation.",
    productionReadiness: "Blocked until production VIP product approval and owner activation.",
    productId: "cw_vip_pass_sandbox_499",
    providerType: "one-time consumable/pass",
    providerConfigured: "sandbox proved",
    productionReady: "missing production product approval",
    ...
    refundPolicy: "No standard refund after valid 30-day access is delivered; failed delivery, early removal, or material misrepresentation may be reviewed, and authoritative reversals reconcile separately.",
    disputePolicy: "Use creator id, provider event, VIP pass row, and access grant readback.",
    creatorExpectation: "VIP is creator-specific; its 30-day access term is separate from the seven-day earnings hold and reserve; production payouts remain off.",
    rollback: "Set digital_sales_enabled off for activation gate; stop new VIP purchases; existing VIP remains only until its canonical 30-day expiry unless refund/revocation removes it sooner.",
  },
  {
    label: "Event Pass",
    ...
    creatorExpectation: "Event Pass earnings require successful canonical event completion plus 48 hours and reserve; production payouts remain off.",
