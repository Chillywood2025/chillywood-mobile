...
operation_sets=(
  ...
  "read_active_baseline,compute_detection_hash,compute_resolution_hash,evaluate_product_baseline,record_sentinel_evaluator_proof,read_product_quality_snapshot"
...
wrapper_sets=(
  ...
  "collect_sentinel_run"
  "product_quality_detection_assessment_hash,product_quality_resolution_assessment_hash,governance_evaluate_product_experience_baseline_v1,product_quality_record_sentinel_evaluator_proof,product_quality_evaluator_snapshot"
