...
assertIncludes(vodDoc, "Protected Premium HD delivery path is source/proofed through `workers/premium-media-access/worker.mjs`.", "VOD doc Premium CDN Worker source/proof boundary");
assertIncludes(vodDoc, "It is not deployed and does not make HD live.", "VOD doc Premium CDN Worker not live");
