...
assertIncludes(merchCheckout, "userHasConfiguredSandboxTesterAccess", "merch checkout server-configured tester access check");
assertIncludes(merchCheckout, "INTERNAL_SANDBOX_TESTER_EMAILS", "merch checkout server-side tester allowlist");
...
assertIncludes(merchCheckout, "owner/operator accounts, active beta testers, or server-configured internal tester sandbox accounts", "merch checkout bounded tester copy");
