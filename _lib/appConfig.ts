...
export const normalizeAppConfig = (raw: unknown): AppConfig => {
  ...
  return {
    ...
    branding: {
      appDisplayName: toText(branding.appDisplayName, DEFAULT_APP_CONFIG.branding.appDisplayName),
      homeHeroKicker: toText(branding.homeHeroKicker, DEFAULT_APP_CONFIG.branding.homeHeroKicker),
      watchPartyLabel: toText(branding.watchPartyLabel, DEFAULT_APP_CONFIG.branding.watchPartyLabel),
      liveWaitingRoomTitle: toText(branding.liveWaitingRoomTitle, DEFAULT_APP_CONFIG.branding.liveWaitingRoomTitle),
      partyWaitingRoomTitle: toText(branding.partyWaitingRoomTitle, DEFAULT_APP_CONFIG.branding.partyWaitingRoomTitle),
      liveRoomTitle: toText(branding.liveRoomTitle, DEFAULT_APP_CONFIG.branding.liveRoomTitle),
      partyRoomTitle: toText(branding.partyRoomTitle, DEFAULT_APP_CONFIG.branding.partyRoomTitle),
