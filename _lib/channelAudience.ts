...
export async function followChannel(channelUserId: string): Promise<ChannelAudienceActionResult> {
  ...
  if (!context.channelUserId) {
    return buildActionResult({
      ...
      message: "This Platform could not be identified. Return to the creator's Platform and try again.",
  ...
  if (!context.viewerUserId) {
    return buildActionResult({
      ...
      status: "blocked",
      reason: "signed_out",
      message: "Sign in to follow this Platform.",
      actorScope: context.actorScope,
      requiredScope: "viewer",
      channelUserId: context.channelUserId,
      viewerUserId: context.viewerUserId,
  ...
  if (context.viewerUserId === context.channelUserId) {
    return buildActionResult({
      ...
      status: "blocked",
      reason: "self_target",
      message: "You cannot follow your own Platform.",
      actorScope: context.actorScope,
      requiredScope: "viewer",
      channelUserId: context.channelUserId,
      viewerUserId: context.viewerUserId,
  ...
  if (existing) {
    return buildActionResult({
      ...
      message: "You already follow this Platform.",
      actorScope: context.actorScope,
      requiredScope: "viewer",
      channelUserId: context.channelUserId,
      viewerUserId: context.viewerUserId,
  ...
  if (error) {
    return buildActionResult({
      ...
      message: "This Platform could not be followed right now. Try again later.",
      actorScope: context.actorScope,
      requiredScope: "viewer",
      channelUserId: context.channelUserId,
      viewerUserId: context.viewerUserId,
...
export async function unfollowChannel(channelUserId: string): Promise<ChannelAudienceActionResult> {
  ...
  if (!context.viewerUserId) {
    return buildActionResult({
      ...
      status: "blocked",
      reason: "signed_out",
      message: "Sign in to unfollow this Platform.",
      actorScope: context.actorScope,
      requiredScope: "viewer",
      channelUserId: context.channelUserId,
      viewerUserId: context.viewerUserId,
  ...
  if (!existing) {
    return buildActionResult({
      ...
      message: "You are not following this Platform.",
      actorScope: context.actorScope,
      requiredScope: "viewer",
      channelUserId: context.channelUserId,
      viewerUserId: context.viewerUserId,
  ...
  if (error) {
    return buildActionResult({
      ...
      message: "This Platform could not be unfollowed right now. Try again later.",
      actorScope: context.actorScope,
      requiredScope: "viewer",
      channelUserId: context.channelUserId,
      viewerUserId: context.viewerUserId,
...
export async function removeChannelFollower(input: {
  ...
  if (!context.channelUserId) {
    return buildActionResult({
      ...
      status: "blocked",
      reason: "missing_channel_user_id",
      message: "This Platform could not be identified. Return to Platform Studio and try again.",
      actorScope: context.actorScope,
  ...
  if (!context.isOwner && !context.canOperateAcrossChannels) {
    return buildActionResult({
      ...
      message: "Only the Platform owner or an authorized admin can remove followers.",
      actorScope: context.actorScope,
      requiredScope: "owner_or_operator",
      channelUserId: context.channelUserId,
      viewerUserId: context.viewerUserId,
  ...
  if (!existing) {
    return buildActionResult({
      ...
      status: "noop",
      reason: "not_following",
      message: "This person is not following this Platform.",
      actorScope: context.actorScope,
      requiredScope: "owner_or_operator",
      channelUserId: context.channelUserId,
      viewerUserId: context.viewerUserId,
  ...
  if (error) {
    return buildActionResult({
      ...
      status: "error",
      reason: "delete_failed",
      message: "This follower could not be removed right now. Try again later.",
      actorScope: context.actorScope,
      requiredScope: "owner_or_operator",
      channelUserId: context.channelUserId,
      viewerUserId: context.viewerUserId,
  ...
  return buildActionResult({
    ...
    status: "completed",
    reason: "allowed",
    message: "Follower removed from this Platform.",
    actorScope: context.actorScope,
    requiredScope: "owner_or_operator",
    channelUserId: context.channelUserId,
    viewerUserId: context.viewerUserId,
...
export async function createChannelAudienceRequest(input: {
  ...
  if (context.viewerUserId === context.channelUserId) {
    return buildActionResult({
      ...
      status: "blocked",
      reason: "self_target",
      message: "You cannot request audience access to your own Platform.",
      actorScope: context.actorScope,
      requiredScope: "viewer",
      channelUserId: context.channelUserId,
      viewerUserId: context.viewerUserId,
  ...
  if (error || !data) {
    return buildActionResult({
      ...
      status: "error",
      reason: "insert_failed",
      message: "The audience request could not be created right now. Try again later.",
      actorScope: context.actorScope,
      requiredScope: "viewer",
      channelUserId: context.channelUserId,
      viewerUserId: context.viewerUserId,
...
export async function cancelChannelAudienceRequest(requestId: number): Promise<ChannelAudienceActionResult> {
  ...
  if (!canCancel) {
    return buildActionResult({
      ...
      message: "Only the requester, Platform owner, or an authorized admin can cancel this audience request.",
      actorScope: context.actorScope,
      requiredScope: "requester_or_owner_or_operator",
  ...
  if (error) {
    return buildActionResult({
      ...
      status: "error",
      reason: "delete_failed",
      message: "The audience request could not be canceled right now. Try again later.",
      actorScope: context.actorScope,
      requiredScope: "requester_or_owner_or_operator",
      channelUserId: request.channel_user_id,
      viewerUserId: context.viewerUserId,
...
async function reviewChannelAudienceRequest(
  ...
  if (!context.isOwner && !context.canOperateAcrossChannels) {
    return buildActionResult({
      ...
      status: "blocked",
      reason: "not_owner_or_operator",
      message: "Only the Platform owner or an authorized admin can review this audience request.",
      actorScope: context.actorScope,
      requiredScope: "owner_or_operator",
      channelUserId: request.channel_user_id,
      viewerUserId: context.viewerUserId,
    ...
    if (!existingFollower) {
      ...
      if (followerInsertError) {
        return buildActionResult({
          ...
          status: "error",
          reason: "insert_failed",
          message: "The follow request could not be approved right now. Try again later.",
          actorScope: context.actorScope,
          requiredScope: "owner_or_operator",
          channelUserId: request.channel_user_id,
          viewerUserId: context.viewerUserId,
  ...
  if (error || !data) {
    return buildActionResult({
      ...
      message: "The audience request could not be reviewed right now. Try again later.",
      actorScope: context.actorScope,
      requiredScope: "owner_or_operator",
      channelUserId: request.channel_user_id,
      viewerUserId: context.viewerUserId,
...
export async function blockChannelAudienceMember(input: {
  ...
  if (blockedUserId === context.channelUserId) {
    return buildActionResult({
      ...
      status: "blocked",
      reason: "self_target",
      message: "A Platform cannot block its own owner.",
      actorScope: context.actorScope,
      requiredScope: "owner_or_operator",
      channelUserId: context.channelUserId,
      viewerUserId: context.viewerUserId,
  ...
  if (!context.isOwner && !context.canOperateAcrossChannels) {
    return buildActionResult({
      ...
      status: "blocked",
      reason: "not_owner_or_operator",
      message: "Only the Platform owner or an authorized admin can block an audience member.",
      actorScope: context.actorScope,
      requiredScope: "owner_or_operator",
      channelUserId: context.channelUserId,
      viewerUserId: context.viewerUserId,
  ...
  if (existing) {
    return buildActionResult({
      ...
      message: "This person is already blocked from this Platform.",
      actorScope: context.actorScope,
      requiredScope: "owner_or_operator",
      channelUserId: context.channelUserId,
      viewerUserId: context.viewerUserId,
  ...
  if (error) {
    return buildActionResult({
      ...
      status: "error",
      reason: "insert_failed",
      message: "This audience member could not be blocked right now. Try again later.",
      actorScope: context.actorScope,
      requiredScope: "owner_or_operator",
      channelUserId: context.channelUserId,
      viewerUserId: context.viewerUserId,
...
export async function unblockChannelAudienceMember(input: {
  ...
  if (!context.isOwner && !context.canOperateAcrossChannels) {
    return buildActionResult({
      ...
      status: "blocked",
      reason: "not_owner_or_operator",
      message: "Only the Platform owner or an authorized admin can unblock an audience member.",
      actorScope: context.actorScope,
      requiredScope: "owner_or_operator",
      channelUserId: context.channelUserId,
      viewerUserId: context.viewerUserId,
  ...
  if (error) {
    return buildActionResult({
      ...
      status: "error",
      reason: "delete_failed",
      message: "This audience member could not be unblocked right now. Try again later.",
      actorScope: context.actorScope,
      requiredScope: "owner_or_operator",
      channelUserId: context.channelUserId,
      viewerUserId: context.viewerUserId,
