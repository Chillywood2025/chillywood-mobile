...
export const SEVEN_FLOW_SWITCHBOARD: readonly SevenFlowSwitchboardRow[] = [
  ...
  },
  {
    ...
    accessNotCreated: "No auto-renewal, Premium, Channel Subscription, ordinary Paid Video ownership, Seat Pass, Event Pass, other creator VIP, LiveKit authority, payout, or payable balance.",
