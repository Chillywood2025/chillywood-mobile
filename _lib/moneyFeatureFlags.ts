...
const MONEY_FEATURE_FLAG_LABELS: Record<MoneyFeatureFlagKey, string> = {
  ...
  tips_enabled: "Tips",
  watch_party_tickets_enabled: "Party Room Passes",
  watch_party_seats_enabled: "Party Room admission limits",
  live_watch_party_access_enabled: "Live Stage Passes",
  live_watch_party_seats_enabled: "Live Stage Seat Passes",
...
const MONEY_FEATURE_FLAG_DESCRIPTIONS: Record<MoneyFeatureFlagKey, string> = {
  ...
  watch_party_tickets_enabled: "Controls paid Party Room Pass claims and sale controls.",
  watch_party_seats_enabled: "Controls paid Watch-Party seat access claims and sale controls.",
  live_watch_party_access_enabled: "Controls paid Live Stage Pass entry claims and sale controls.",
