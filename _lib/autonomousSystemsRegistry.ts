    ...
    surfaces: [
      {
        ...
        approvalLevel: 2,
        allowedReadScope: ["support queue summaries", "stale ticket labels", "Premium/payment readback labels"],
        allowedWriteScope: ["support_health_snapshots", "support_ticket_findings", "support_response_drafts", "support_required_review_flags"],
        forbiddenScope: ["refund execution", "Premium grant", "credential reset", "external legal/payment commitment"],
