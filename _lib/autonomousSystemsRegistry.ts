...
export const AUTONOMOUS_SYSTEMS_REGISTRY = [
  ...
  },
  {
    ...
    schedulerStatus: "no_money_mutation_scheduler_enabled",
    ...
    surfaces: [
      {
        ...
        allowedWriteScope: ["read-only reports", "approval request creation"],
      ...
      },
      {
        ...
        allowedWriteScope: ["zero-dollar/sandbox proof rows", "scoped provider status row sync"],
