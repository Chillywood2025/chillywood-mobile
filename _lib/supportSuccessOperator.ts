...
export const buildSupportSuccessWatchPlan = () => ({
  ...
  checks: ["support_inbox_health", "stale_support_ticket_detection", "refund_request_classification", "support_response_drafts", "escalation_to_owner_admin"],
  forbidden: ["issuing refunds", "granting Premium", "moving money", "resetting credentials without approved flow", "sending legal/payment commitments"],
});
