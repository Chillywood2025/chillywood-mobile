...
2. Load OTA group `4181cac8-a69e-4cdb-8f30-d30b8b821a7a` / Android update `019f427b-94bf-73bb-8891-22448e265ec8`, then re-prove the installed Party Room `Connecting…` / Open Shared Player progression using test-ID taps. Do not use the room code as a direct Player `partyId` workaround.
