...
- Production HLS/transcoding is still not live: no backend transcode queue/service worker, no trusted `video_renditions` rows for the proof HLS assets, and no creator-video playback migration.
