...
1. D2A PR #212 is admitted from exact synchronized source 87833399360e99f7ad630ebbb1c5643a57f1481f tree aadc47f810525d925b1a4a413d7ded1af581b678 after protected admission PR #213 merges.
2. Execute only local release-critical Android generated-native, lifecycle, and current LiveKit microphone proof; preserve PR #210 product behavior and the historical PR #194 and PR #195 incident records.
3. Do not start either internal signed candidate until D2A merges and the post-D2A three-file current-truth authorization merges; do not release publicly.
...
Do not create a release or distribution build before D2A and its post-merge truth authorization, publish OTA, mutate a provider or database, enable a switch or schedule, change Premium, money, rights, auth or RLS, start Responsive Layout V2 or AppLovin, or release publicly.
