...
2a. Source-aware Premium HD generation is closed for the current HD-capable public-safe set: City Lights remains SD-only because the source is 854x480; three 1280x720 sources have protected 720p; one 720x1280 source has protected 720p plus 1080p. Next Premium HD milestone is a backend/app token-issuer and installed-app Premium playback proof, not more HD generation for the current catalog. Do not expose HD through `playback/public/`, and do not process private/Premium/original media.
...
11. Do not expose protected Premium HD through unsigned public CDN. Future installed-app Premium HD playback requires the protected Worker route, active Premium entitlement proof, a backend token issuer, and fallback/free-user denial proof.
