...
- Final Blocker Closeout after Wave 5.1: app-controlled Wave 5.1 blockers are closed. Remaining known blockers are classified as:
  ...
  - Installed Android account deletion/restore visual proof: `Partial`; Play-installed UI/copy and restore/cancel visual proof passed, backend cleanup readback confirmed the proof account is active/not scheduled, and immediate scheduled-state visual capture remains inconclusive.
...
- Installed Visual Closeout:
  ...
  - Installed account deletion/restore visual proof: `Partial`; Settings deletion UI and scheduled-deletion / 30-day restore copy were reachable, restore/cancel visual proof completed, and backend cleanup readback confirmed the proof account is active/not scheduled. Immediate post-delete scheduled-state visual capture remained inconclusive, so schedule-state visual remains Partial.
