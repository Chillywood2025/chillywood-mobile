...
1. Use only the code-pinned PR #206 S0 Owner-bootstrap registry tuple, scope-governed repository evidence anchor, hash-bound source claim, canonical Owner comment, and fresh active-task packet to authorize Codex Security Scan Reliability S0; no other PR, branch, head, fact, feature, product, provider, build, release, or D2A work is authorized.
