...
1. Merge this bounded current-truth synchronization, normally merge main into PR #116, and reuse its four persistent Level C review lanes with additive v2 evidence.
