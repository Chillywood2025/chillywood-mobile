...
1. Complete the bounded PR #205 late-review owner-registry bootstrap with its FORMAL_REVIEW tier boundary, exact hash-bound complete PR 194/195 sentinel inventory, and protected-main-only resolution tombstone admission; restore and read back the exact-head required check immediately, then synchronize post-A1 truth.
