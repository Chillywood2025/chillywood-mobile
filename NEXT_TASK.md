...
- 2026-07-13 authority blocker follow-up supersedes the normal `/chat`, creator `/creator-monetization-setup`, and focused moderator-boundary blockers. Production OTA group `8e158980-75d1-47ef-bd26-f3f9e564fdab`, Android update `019f58f4-55ea-7d55-b1b1-6ea85fdb1c56`, source commit `32e56c3abb5c046e853a9c2f3d978ba72af447f4`, loaded on Play-installed `R5CR120QCBF` with runtime `1.0.0`, channel `production`, embedded/emergency launch `false`. Normal `/chat` shows `chat-inbox-screen`; the creator compatibility route shows Platform Studio `Premium required` / `Manage Premium`; moderator focused proof shows no broad Admin Search, owner approvals, direct enforcement controls, or private evidence. Installed authority proof remains Partial only for exact prerequisites: an actually restricted approved proof account/fixture, a provider-backed Premium-active installed account/session or approved Google Play / RevenueCat sandbox renewal, and two Play-installed devices for realtime.
