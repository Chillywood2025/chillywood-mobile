...
- Capture a Platform view where `@username` is visibly rendered, or fix that UI if product expects the handle on the currently captured Platform view.
- Capture Chi'lly Chat handle display with a safe existing chat thread fixture.
