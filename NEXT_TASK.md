...
1. Merge this exact three-file current-truth correction binding for draft PR #152 immutable D2C source 01756602fa6fc92feb32adadb0fb11be8f304a85 only after persistent Level A PR #124 reports P0=0/P1=0 and the exact current-truth CI passes; close PR #124 unmerged and retain its branch.
2. Then base-synchronize PR #152 through one normal --no-ff merge of current main, preserve immutable D2C source 01756602fa6fc92feb32adadb0fb11be8f304a85, rerun focused generation compile and local mounted equivalent integration, and update exactly four persistent Level C review-only lanes additively while retaining their historical rejected-head evidence.
3. Require all four D2C review lanes to report P0=0/P1=0 and explicitly accept the local mounted native-bridge and native-intent proof together with the blocked OS URL callback limitation before one exact Phase 1 CI and merge of only PR #152.
...
8. Keep all review-only branches retained and never merge them.
