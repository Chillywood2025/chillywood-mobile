...
- Final Four Launch Conditions:
  ...
  - Permanent purge/de-identification: `Closed for proof-account policy implementation`; current proved lifecycle covers scheduled deletion, restore/cancel, public hiding, disabled access denial, admin/operator suspend/restore, and disposable proof-account de-identification. No real-user broad auto-purge job or legal compliance claim is made.
