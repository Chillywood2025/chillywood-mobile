...
2. Keep the completed single-device and two-phone proof baseline intact everywhere else without widening into another verification lane in this pass.
3. Keep the landed Party Room invite open-path, room-aware invite search, watch-party lane-switch, locked-room denial, dev-only live-room invite autolaunch removal, and prior Live Stage interaction/runtime hardening intact without widening them into new product work.
4. Keep the new Android Live Stage runtime fixes intact:
...
- treat release hardening later as blocked on later proof work, but keep this pass itself code-side and smoke-only
- keep unrelated local dirt out of the checkpoint
