...
1. Before any S0 plan, packet, implementation, review, or CI command: merge this post-A1 truth, reopen retained draft PR #206, merge exact current main normally with --no-ff into codex/assurance-codex-security-scan-reliability-s0, introduce a hash-bound S0 repository source claim plus structured active binding, render canonical documents, and require a fresh active-task packet bound to that exact S0 source and synchronized head.
