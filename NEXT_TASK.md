...
3. Admin Usage later writers:
   ...
   - creator-video upload usage writer V1A0/V1A1 is pushed for `video_uploaded` and `storage_bytes` metadata only after successful backed video row creation
