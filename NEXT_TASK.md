...
1. Use only the code-pinned PR #206 S0 Owner-bootstrap registry tuple, immutable authoritative-lifecycle and exact prior-finding-closure correction source 0ea47946efcb557de210c5779dadbed375c9dd9e tree 2f6e98465933b40dd0e29a5409ad303baeab2fe0, hash-bound source claim, canonical Owner comment 5241070565, and fresh active-task packet to authorize Codex Security Scan Reliability S0; no other PR, branch, head, fact, feature, product, provider, build, release, or D2A work is authorized.
