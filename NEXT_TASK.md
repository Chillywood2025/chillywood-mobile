...
2. First resolve or re-prove the installed Party Room `Connecting…` / Open Shared Player progression on the latest OTA. Do not use the room code as a direct Player `partyId` workaround.
