...
2a. Source-aware rendition ladder is now implemented for planning: 480p sources request 360p/480p, 720p sources can add 720p, and 1080p sources can add 720p/1080p. Premium token claims are source/proofed, but Premium HD remains blocked from current public R2/HLS execution until protected Premium output paths, a tokenized URL signer, and HD generation proof are installed. Do not process media solely to test this lane.
