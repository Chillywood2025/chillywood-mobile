...
1. Merge this exact three-file current-truth correction binding for draft PR #152 immutable D2C source 442852da70d723aedcf6ad1fa76c2f3eb23d3e0e only after persistent Level A PR #124 reports P0=0/P1=0 and the exact current-truth CI passes; close PR #124 unmerged and retain its branch.
2. Then base-synchronize PR #152 through one normal --no-ff merge of current main, preserve immutable D2C source 442852da70d723aedcf6ad1fa76c2f3eb23d3e0e, rerun focused generation compile and local route-bridge integration, and update exactly four persistent Level C review-only lanes additively while retaining their historical rejected-head evidence.
