...
1. Merge this bounded current-truth synchronization, then push and review the existing frozen B1 LiveKit source-binding successor without deploying its forward-only correction.
2. Continue the existing B2 RevenueCat transfer and B3 room-host block-check successors in order, with exact reviews and applicable CI before merge and no provider mutation.
