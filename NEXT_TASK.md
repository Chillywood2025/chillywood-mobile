...
4. Use the now-ready EAS Update config/docs baseline to publish and verify a preview OTA before any production rollout
...
- execute the first preview-channel EAS Update publish and delivery verification without reopening proof
...
- the first preview OTA is published from the proved checkpoint and verified on the preview build/runtime
