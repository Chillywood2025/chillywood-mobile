...
5. Treat `docs/hetzner-first-deployment-implementation-spec.md` and `infra/hetzner/*.example` as deployment-planning reference only; the current known Hetzner host facts and SSH bootstrap expectation do not change the active next product chapter.
