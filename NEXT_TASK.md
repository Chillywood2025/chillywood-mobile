...
1. RESUME_PR_212_D2A_NATIVE_LIFECYCLE_EXECUTION
2. Merge current main normally into PR #212 without rebasing, retain its existing PR #213 finite lease, and complete the remaining native/lifecycle matrix before final exact-head review and Phase 1.
