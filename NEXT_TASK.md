...
4. Finance proof and later writers:
   ...
   - Finance F2 payout-provider and Network Billing closeouts are complete for foundation-only schema/readout/proof rows; moderator visibility proof still requires a later safe lane before operational reliance
