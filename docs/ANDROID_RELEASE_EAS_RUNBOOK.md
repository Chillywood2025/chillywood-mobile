...
| Production AAB profile | Internal Test Partial / Purchase Proof Pending | `production` profile uses Android `app-bundle`; build `aedded50-3818-4d7b-8bcf-9bb9c2d36513` completed for versionCode `2` and was manually uploaded to Internal Testing; build `96e60082-00b1-48dc-843b-132ce82a7710` completed for versionCode `3`; EAS submitted versionCode `3` to the internal track only as submission `920c452f-1b9f-401c-94c9-616801684939` | Register the Play developer payments profile, create/activate the Play subscription `premium_subscription` monthly $9.99 base plan, attach/import it in RevenueCat, then run internal-test install, purchase, restore, and entitlement proof |
