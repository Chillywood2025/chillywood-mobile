...
This document defines hold types and release expectations for future payout operations. Payouts are currently not active.
...
Hold types include standard review hold, new creator hold, chargeback hold, fraud hold, policy hold, KYC hold, tax hold, negative balance hold, refund reserve hold, support dispute hold, legal request hold, and provider disabled hold. A hold is a risk-control state, not a punitive statement by itself. It should describe what is needed for review without promising release.

## Release Standard

A hold should be released only when the underlying blocker is resolved, evidence is recorded, provider requirements are satisfied, refund and chargeback exposure is understood, tax readiness is satisfied, and an authorized Owner/Admin decision is logged. No hold release should create cash-out or transfer ability unless production payouts are active and the creator is eligible.

## Creator Communication

Creator-facing copy should say that payout readiness is under review and list the non-sensitive category of the blocker. Support should not disclose fraud rules in a way that helps evasion. Support should not promise a release date unless the policy and provider status support it.
