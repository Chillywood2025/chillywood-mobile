...
- Creator login on Play/internal v37 passed. Money Center visual Transactions readback passed for the exact purchase: `/tmp/chillywood-paid-videos-v1-fixture-proof-20260611-225105/money-center-transactions-detail.*` shows `$0.99 video unlock`, `Paid`, `Chi'llwood Originals Proof Fixture`, `Sandbox`, and copy saying Paid Videos unlock only this creator video, Premium and Tips stay separate, and payout status is `not_payable`.
