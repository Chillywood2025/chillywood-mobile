# Production Money Readiness Index
...
This index organizes the production-money readiness documents so Owner/Admin, legal, tax, risk, support, and product reviewers can find the correct operating packet without treating readiness as activation.
...
Start with the main readiness packet, then inspect the domain packet that matches the proposed activation. Digital production requires legal, Play, RevenueCat, refund, support, risk, and Data Safety review. Merch production requires merch terms, fulfillment, returns, sales tax, Stripe live readiness, support, fraud, privacy, and Owner approval. Payout production requires payout terms, Stripe Connect live readiness, KYC and tax requirements, payout holds, support, fraud review, tax reporting, and Owner approval. The index should be used as a checklist hub, not as permission to launch.

## Document Families

Legal documents define creator monetization obligations, digital purchase rights, merch obligations, payout terms, and legal review questions. Tax documents define 1099, sales tax, nexus, W-9/W-8, record retention, and advisor review. Risk documents define suspicious activity, payout holds, merch risk, and disputes. Support documents define categories, evidence, escalation, and response limits. Policy documents define refunds, returns, cancellations, and access revocation. Admin documents define approval gates and kill switches.

## Remaining Blockers

The remaining blockers are not sandbox proof blockers. They are approval and operating blockers: legal signoff, tax signoff, provider live readiness, refund process ownership, support staffing, fraud review ownership, merch fulfillment ownership, payout terms acceptance, privacy/Data Safety review, and rollback readiness. If any item is missing, production should stay locked.
