...
June 13, 2026 Channel Subscriptions V1 status: implemented, Supabase-applied, webhook-deployed, and core Play/internal sandbox-purchase-proven. Creator channel subscriptions are recurring Android digital access and use RevenueCat / Google Play subscriptions, not Stripe Tips. Google Play product `channel_subscription_sandbox_monthly_499` has active monthly base plan `monthly`; RevenueCat product `channel_subscription_sandbox_monthly_499:monthly` is published and attached to entitlement `creator_channel_subscription`. Play/internal v51 on `R5CR120QCBF` proved package `com.chillywood.mobile`, installer `com.android.vending`, and versionCode `51`; after a cold app restart Google Play Billing opened, the sandbox subscription purchase completed, provider event `9dabc47f-61f7-49f7-a169-3adb0ebbac30` processed, and Supabase created active subscription `436f2acc-ec46-4977-ba51-958452ea2f2e`, paid/not-payable transaction `e49cddea-cd6d-4097-b70c-a07abaa24823`, and sandbox access grant `1a5492fe-c135-435e-878c-5e21a7638322`. The subscribed fan saw `SUBSCRIBED` on `/channel-subscription/[creatorId]`. Channel subscriptions unlock only subscriber state for that creator channel and do not include Chi'llwood Premium, VIP, Paid Videos, Paid Watch-Party tickets, Paid Events, Tips, LiveKit authority, payout access, cash-out, withdrawal, transfer, platform-wide badge/status, or other creators' channels. Live money remains off, sandbox rows are `not_payable`, and Money Center must not present subscription revenue as withdrawable. Remaining proof: creator Money Center visual transaction screenshot, second authenticated unsubscribed-fan UI denial after purchase, and cancellation/expiration/revoke only when safe RevenueCat / Google Play tooling exists. Dedicated proof doc: `docs/CHANNEL_SUBSCRIPTIONS_V1_END_TO_END_PROOF.md`.
...
June 13, 2026 Channel Subscriptions V1 Android proof update: the provider catalog blocker is closed. Google Play product `channel_subscription_sandbox_monthly_499` has active base plan `monthly`, RevenueCat product `channel_subscription_sandbox_monthly_499:monthly` is attached to entitlement `creator_channel_subscription`, and Play/internal v51 completed one sandbox subscription purchase. Provider event `9dabc47f-61f7-49f7-a169-3adb0ebbac30` created active subscription `436f2acc-ec46-4977-ba51-958452ea2f2e`, paid/not-payable transaction `e49cddea-cd6d-4097-b70c-a07abaa24823`, and sandbox access grant `1a5492fe-c135-435e-878c-5e21a7638322`. Channel subscriptions remain sandbox-only and unlock only one creator-channel subscriber state. Money Center must label subscription rows as sandbox/not_payable until live money is explicitly approved. Remaining proof: creator Money Center visual transaction screenshot, second authenticated unsubscribed-fan UI denial after purchase, and cancellation/expiration/revoke if safe provider tooling exists.
