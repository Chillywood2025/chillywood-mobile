...
Scheduler status: `firebase_scheduler_service_completion_blocked`. The scheduler is not active; scheduler is blocked until the systemd Firebase smoke service exits cleanly and posts timer audit.
