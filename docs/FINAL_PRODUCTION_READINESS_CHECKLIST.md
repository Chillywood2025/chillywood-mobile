...
| Support/refund/dispute | Partial but policy-ready | Final operations runbook covers Premium support, creator-money support, manual/external provider refunds, disputes, paid-content unavailable states, event/room no-show handling, account deletion support, DMCA/support privacy, and owner/support roles. | No for non-money or Premium proof preparation; money launch needs staffed support owner. | Assign support owner before Premium activation; keep refund execution manual/external. |
