...
- Role terminology: Locked. Admin is the product-facing role backed by internal `operator`; Support is a work area, not a staff role; Moderator is separate from Admin/operator and can receive support duties through scoped permissions.
