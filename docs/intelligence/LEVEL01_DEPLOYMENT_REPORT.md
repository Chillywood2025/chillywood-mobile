...
- full local pgTAP passed 669/669;
...
- no build, OTA, TestFlight, Google Play, merge, money, rights, auth/RLS, role,
  moderation, ranking, provider-product, or public-release mutation.
