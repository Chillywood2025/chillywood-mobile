...
covered by 147 cognitive pgTAP assertions and a real two-session recurrence race.
`test:cognitive-hardening-regressions` adds 38 variants derived from the failed
