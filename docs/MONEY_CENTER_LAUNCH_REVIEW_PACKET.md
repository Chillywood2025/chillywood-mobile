...
Internal tester sandbox addendum: `docs/INTERNAL_TESTER_SANDBOX_PURCHASE_MODE.md` documents the bounded tester-only purchase mode. Public/default purchase surfaces remain closed; approved testers can run clearly labeled sandbox purchases without activating production money, payouts, cash-out, payable balances, or public buy buttons.
