...
- Rachi is the official public platform guide/presence on backed Profile, public Platform, Chi'lly Circle, Home, Support/onboarding, and Admin management surfaces. Rachi is not Admin, not an operator role, not a Chi'lly Chat starter/helper thread, and not a private-chat monitor; backend-protected Admin may still manage or inspect Rachi official-account presence where backed.
