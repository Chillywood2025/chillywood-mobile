...
Use this exact spelling in user-facing app copy, normal product docs, QA docs, BrowserStack docs, legal docs, public-site content, email templates, README/status docs, and AI guidance.
