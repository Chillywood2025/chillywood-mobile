...
| `watch_party_ticket` | Watch-Party Seat Pass | Refund review if buyer has not entered/used the room and room is canceled/unavailable or platform fault blocks access. No standard refund after entry/use unless platform fault or provider/legal/admin decision. | Cash refund or credit review. | Room obligation must be met. | Required until room obligation and refund window clear. |
