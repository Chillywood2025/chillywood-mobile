...
| Moderation/reporting workflow | Drafted pending attorney review / partially implemented | Generic reporting/admin moderation foundation exists; dedicated production DMCA Admin case-management tooling exists; public hosted DMCA form exists and is canary-proved. General report lifecycle, outbound email automation, uploader-facing counter-notice self-service, attachment storage/scanning/retention, and fraud/sponsor enforcement remain pending. |
