...
June 4, 2026 internal tester sandbox purchase mode update: `docs/INTERNAL_TESTER_SANDBOX_PURCHASE_MODE.md` records the bounded tester-only opening for sandbox purchases. Public/default purchase surfaces remain closed, but approved testers can run clearly labeled Google Play / RevenueCat sandbox Premium and digital-product tests. This reduces internal-test friction without activating production money, payouts, cash-out/withdraw/transfer, payable balances, public buy buttons, fake sales, Stripe Android digital checkout, LiveKit authority, route ownership changes, or safety bypass.
