...
| Watch-Party Live Seat Pass | `watch_party_live_ticket_sandbox_099` | `cw_watch_party_live_ticket_sandbox_099` | Google Play / RevenueCat | `$0.99 sandbox/test` |
...
- Money Center exposes actionable setup controls for Tips, Paid Video, Watch-Party Seat Pass, Channel Subscription, VIP, and Event Pass in sandbox/not-payable mode.
