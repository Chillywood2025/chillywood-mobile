...
| Copyright / DMCA | `https://chillywoodstream.com/copyright` | HTTP/2 308 to `/copyright/`, then HTTP/2 200 | Live URL / DMCA External Setup Pending | Final DMCA contact/process, designated-agent public posting, and Copyright Office registration remain external before any safe-harbor completion claim. |
...
- Final DMCA agent/contact process, public posting, and any required designated-agent registration.
