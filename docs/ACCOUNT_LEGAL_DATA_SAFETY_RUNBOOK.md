...
- automated malware scanning is not configured and must not be claimed; after the May 30 decision closeout it is not required for controlled Public V1 and remains a P2 future provider lane unless Play/legal review reclassifies it;
...
May 30 malware-scanning decision note: automated malware scanning is unconfigured and unclaimed, with DMCA/report evidence kept private/manual-review. It is not a controlled Public V1 blocker under the current launch boundary; it is a P2 future provider lane unless Play/legal review explicitly requires it.
