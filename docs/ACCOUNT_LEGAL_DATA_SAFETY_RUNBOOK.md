...
- DMCA designated agent public contact posting and U.S. Copyright Office registration are recorded complete under registration `DMCA-1072720`; formal notice intake, owner/operator Admin case tooling, Admin-recorded counter-notices, strike tracking, repeat-infringer review, and audit history are backed. Attorney review, support inbox receipt proof, live end-to-end workflow proof, uploader-facing counter-notice submission, and outbound email automation remain pending.
...
- Live end-to-end DMCA proof with safe reporter/uploader/admin accounts and supported content target; uploader-facing counter-notice submission and outbound email automation remain pending unless handled manually through Support/Admin.
...
| Copyright / DMCA | `https://chillywoodstream.com/copyright` | HTTP/2 308 to `/copyright/`, then HTTP/2 200 | Live URL / DMCA Agent Registered / DMCA Tooling Added / Attorney Review Pending | Copyright page lists designated agent contact and registration `DMCA-1072720`; formal notice intake, Admin case tooling, Admin-recorded counter-notices, strike tracking, repeat-infringer review, and audit history are backed. Attorney review, support receipt proof, and live end-to-end workflow proof remain pending. |
| Support | `https://chillywoodstream.com/support` and `support@chillywoodstream.com` | HTTP/2 308 to `/support/`, then HTTP/2 200; Cloudflare destination/routing is configured | Live URL / Inbox Receipt Proof Pending | Send a real test message to `support@chillywoodstream.com` and approve support owner/SLA. |
...
- DMCA designated agent registration/contact maintenance; registration `DMCA-1072720` is recorded complete, and backed DMCA tooling is added, but attorney review, support receipt proof, uploader-facing counter-notice route, outbound email automation, and live end-to-end workflow proof remain pending.
- Final public support URL, verified `support@chillywoodstream.com` inbox receipt, and account deletion support process/SLA.
- Final backend deletion/de-identification and retention runbook.
