...
- The current in-app report sheet supports a generic copyright category and links to the formal copyright report route. Formal notice intake and hosted public DMCA form submission are backed and live-proof closed; direct uploader-facing counter-notice intake, attachment storage/scanning/retention, and outbound email automation remain pending.
