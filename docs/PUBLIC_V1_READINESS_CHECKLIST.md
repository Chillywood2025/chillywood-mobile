...
- Live layout/effects proof for people-first Live Stage, content-first Party Room, current visible comments placement, Live Stage overlay auto-hide behavior, and foundation-only effects UI.
