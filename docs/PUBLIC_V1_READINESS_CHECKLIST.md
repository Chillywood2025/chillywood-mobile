...
| Android Release Build | External Setup Pending | `app.json`, `app.config.ts`, `eas.json`, package scripts, `docs/ANDROID_RELEASE_EAS_RUNBOOK.md` | Android package, icon/splash, Firebase/RevenueCat/Supabase runtime config owners and production EAS AAB profile exist. The Android release/EAS runbook now documents signing, env, native rebuild, permission, preview build, production AAB, and Play handoff steps. | EAS Android credential verification, versionCode strategy, production env setup, preview build, production AAB build, internal testing install/upload, release route smoke, permissions review, release log audit. | V1 required | Follow `docs/ANDROID_RELEASE_EAS_RUNBOOK.md`; run preview/production build proof after runtime proof lanes and external env/signing setup are ready. |
