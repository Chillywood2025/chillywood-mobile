...
2026-05-25 social attachment note: the current Profile/social attachment UX uses a shared action sheet for backed social attachment entry points. Profile post/comment Attach, Chi'lly Chat Attach, creator-video comment Attach, Watch-Party room comment Attach, and Live Stage comment Attach all offer Photos and Files through the existing social attachment picker type helper. Profile owner Attach may show Platform Studio as the creator-content handoff; this must not appear as viewer owner control or as a generic creator-upload CTA on Profile. The sheet does not change legal evidence uploads, Brand Studio media uploads, Platform Studio creator-video upload, storage/RLS, runtime controls, LiveKit, Premium, monetization, or public Platform routing.
