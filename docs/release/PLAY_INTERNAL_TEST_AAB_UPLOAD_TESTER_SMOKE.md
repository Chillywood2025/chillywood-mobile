...
Visible-surface active wiring tester delivery: Closed. Commit 7138dd2 was pushed to origin/main before delivery. The visible-surface active wiring commit was delivered to the Play internal runtime by EAS Update group `d7aac53c-65bb-4bf7-ae69-04bfea248e0a` with Android update `019f0533-920e-7fca-8f45-74b1f538040a` on branch `production`, runtime `1.0.0`.

The approved tester delivery path remains Google Play internal/closed testing plus compatible EAS Updates to that installed Play runtime. Sideload is not an approved tester delivery path. No APK sideload was used. No app uninstall/reinstall/clear-data happened unless explicitly owner-approved. Testers must verify visible controls in the installed tester build after closing and reopening on a good network. No Play production submission happened. No provider mutation happened. liveMoneyEnabled remains OFF. Payouts, cashout, Stripe Connect production, payable balances, withdrawals, transfers, provider refunds, and automatic refunds remain OFF. Premium annual remains provider-blocked. Creator Channel Subscription remains provider-blocked.
