...
This document defines the questions Chi'llwood must answer before it claims creator tax-reporting readiness.
...
The reporting model depends on the final Stripe Connect configuration, platform money flow, creator role, fee structure, payout schedule, and legal/tax interpretation. Stripe may support tax reporting workflows, but Chi'llwood must confirm whether Stripe, the platform, or both have reporting duties. The app should not tell creators that a specific form will or will not be issued until tax review is complete.
