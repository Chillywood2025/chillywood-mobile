...
This document defines the questions Chi'llywood must answer before it claims creator tax-reporting readiness.
...
The reporting model depends on the final Stripe Connect configuration, platform money flow, creator role, fee structure, payout schedule, and legal/tax interpretation. Stripe may support tax reporting workflows, but Chi'llywood must confirm whether Stripe, the platform, or both have reporting duties. The app should not tell creators that a specific form will or will not be issued until tax review is complete.

## Creator Statements

Creators will likely need annual and periodic statements that separate gross activity, platform fees, provider fees, refunds, chargebacks, holds, reserves, adjustments, and payouts. Statements should not include sandbox rows as earnings. A statement should explain that it is informational and not tax advice. Corrections should have a support workflow and audit trail.

## Operational Requirements

Production readiness requires creator identity collection, taxpayer information strategy, U.S. and non-U.S. handling, threshold monitoring, calendar-year closing process, correction process, support scripts, retention policy, and provider reconciliation. Owner/Admin should see readiness states, not tax secrets or unnecessary sensitive data.
