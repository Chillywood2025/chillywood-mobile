...
7. Public v1 still needs deferred runtime proof: two-device creator-video Watch-Party, live layout/effects proof, draft/private blocked state, signed-out/non-premium blocked state, and final route smoke.
