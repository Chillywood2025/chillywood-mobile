...
Proof artifacts should go under `/tmp/chillywood-revenuecat-googleplay-sandbox-product-proof-20260603/` or `/tmp/chillywood-googleplay-item-availability-real-purchase-proof-20260603/` and remain uncommitted unless a future repo convention explicitly requires otherwise.
