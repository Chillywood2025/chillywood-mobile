...
- Admin Canary legal/DMCA readiness is backed by `admin-owner-controls` ACTIVE version 15. The May 22 physical Android owner-device release run on `R5CR120QCBF` returned `60 pass`, `0 manual_required`, and `0 failed`.
