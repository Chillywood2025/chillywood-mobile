...
insert into expected_runtime_grants(role_name, schema_name, function_name) values
  ...
  ('cognitive_sentinel_collector','cognitive_runtime','preflight_visual_generic_manifest_predicates'),
  ...
  ('cognitive_product_quality_triage','cognitive_runtime','product_quality_triage_livekit_bounded_no_finding'),
  ...
  ('cognitive_public_research_broker','cognitive_runtime','run_attested_research_retention_maintenance'),
...
select is(
  ...
  '93b863048b2b08317daddb38d08ae0e2b0a3b981a2d859558b7eecf05b680753',
...
select is(
  ...
  49,
  'all forty-nine runtime boundary helpers and wrappers are security definer with an empty search path'
);
