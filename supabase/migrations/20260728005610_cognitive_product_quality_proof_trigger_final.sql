-- Restore the stable fail-closed error contract after the value-free
-- subpredicate diagnosis. Confidence scale is canonicalized by the preceding
-- assessment-hash migration; every proof and finding binding remains required.
