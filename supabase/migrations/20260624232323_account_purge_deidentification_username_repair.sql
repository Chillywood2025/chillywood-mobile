-- Repair proof/deleted username formats for the account purge proof RPC.
-- The public handle constraint rejects underscores, so proof and de-identified
-- generated usernames use alphanumeric-only prefixes.
