...
import { evaluateMicControl, legacyModel, liveKitModel, uiModel } from "../../scripts/assurance/android-chat-call-mic-control.mjs";
...
for (const evidence of runs) {
  ...
  assert.equal(evidence.nativeLayer.status, "NOT_RUN_STOPPED_ON_SOURCE_BOUND_P1_CANDIDATES");
}
...
console.log("android mic-control source-bound adapter tests passed (UI 10/10; LiveKit 20/20; legacy 20/20; negative 10/10; deterministic 3/3; 8 unexecuted P1 candidates preserved; T2 blocked pending exact-hook execution)");
