...
test("assurance-control observer accepts only exact protected source-only profiles and strips authority claims", () => {
  ...
  assert.equal(resolveAssuranceControlSourceOnlyProfile({ changedPaths: fixedPointSubset, budget: { maximumFiles: 6, maximumChangedLines: 1800, maximumHandAuthoredNetLines: 1800 }, changedFiles: fixedPointSubset.length })?.profileId, fixedPointProfile.profileId);
  assert.equal(resolveAssuranceControlSourceOnlyProfile({ changedPaths: [...fixedPointSubset, "app/index.tsx"].sort(), budget: { maximumFiles: 6, maximumChangedLines: 1800, maximumHandAuthoredNetLines: 1800 }, changedFiles: fixedPointSubset.length + 1 }), null);
