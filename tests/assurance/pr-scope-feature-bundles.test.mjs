...
test("assurance-control observer accepts only exact protected source-only profiles and strips authority claims", () => {
  ...
  assert.equal(consolidationProfile.paths.length, 25);
  assert.deepEqual({ maximumFiles: consolidationProfile.maximumFiles, maximumChangedLines: consolidationProfile.maximumChangedLines }, { maximumFiles: 25, maximumChangedLines: 6500 });
