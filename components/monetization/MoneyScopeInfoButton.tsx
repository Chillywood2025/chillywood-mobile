...
export const MONEY_SCOPE_INFO: Record<MoneyScopeKey, MoneyScopeInfo> = {
  ...
  creator_tip: {
    ...
    doesNotInclude: [
      ...
      "subscription access",
      "paid videos",
      "Party Room Pass access",
      "Live Stage Pass access",
      "Live Stage Seat Pass access",
      "Event Pass access",
  ...
  watch_party_ticket: {
    ...
    shortDescription: "Entry to one exact Party Room only.",
    includes: [
      "entry to this one exact Party Room while the Party Room Pass is valid",
    ...
    whereItWorks: "Only on the linked Party Room target. It does not unlock Live Stage.",
    whoControlsIt: "Entry still depends on the exact Party Room, Party Room Pass resolver, and route policy.",
  ...
  live_watch_party_access_pass: {
    ...
    shortDescription: "Viewer/listener access to one exact Live Stage while valid.",
    includes: [
      "viewer/listener access to the linked exact Live Stage while valid",
    ],
    doesNotInclude: [
      "speaking seat",
      ...
      "moderator/admin authority",
      "Party Room Pass",
      "Live Stage Seat Pass",
      "Event Pass access",
      "payout access",
    ],
    whereItWorks: "Only on the linked exact Live Stage target.",
  ...
  live_watch_party_seat_pass: {
    ...
    shortDescription: "Speaking-seat eligibility for one exact Live Stage target.",
    includes: [
      "speaking-seat eligibility for the linked exact Live Stage target",
    ],
    doesNotInclude: [
      "guaranteed speaker approval",
      "automatic camera/mic publish access",
      "Live Stage entry when a separate paid Live Stage Pass is required",
      "host power",
      "moderator/admin authority",
      "Party Room Pass access",
      "Event Pass access",
    ...
    whereItWorks: "Only on the linked exact Live Stage where seat eligibility is supported.",
    whoControlsIt: "Host approval and LiveKit token rules still win.",
    lifecycleNote: "A Live Stage Seat Pass only makes the viewer eligible. Rejection remains rejection; current speaker status requires host approval and a persisted server-backed membership.",
    payoutNote: "Live Stage Seat Pass rows remain sandbox/not-payable unless a separate live-money approval lane is completed.",
  },
  channel_subscription: {
