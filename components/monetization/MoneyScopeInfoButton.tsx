...
export const MONEY_SCOPE_INFO: Record<MoneyScopeKey, MoneyScopeInfo> = {
  ...
  watch_party_ticket: {
    ...
    shortDescription: "Entry/access to one Watch-Party room target only.",
    includes: [
      "entry/access to this one Watch-Party room target while the ticket is valid",
    ...
    whoControlsIt: "Room entry still depends on the room, ticket/access resolver, and route policy.",
    lifecycleNote: "Ticket access is viewer/participant entry only. Expired, refunded, revoked, ended, or unsafe rooms should deny access clearly.",
    payoutNote: "Ticket payment/access does not grant payout access or create payable balances while live money is off.",
  },
  live_watch_party_access_pass: {
