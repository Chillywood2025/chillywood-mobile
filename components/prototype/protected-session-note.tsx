...
export const ACCESS_DISCLOSURE_COPY = {
  ...
  futureAccessControls: "Premium and contextual pass rules can apply to eligible rooms and titles, with entitlement handled in-context only when the session requires it.",
