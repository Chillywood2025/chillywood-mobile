...
export const CREATOR_UPLOAD_ACKNOWLEDGEMENT =
  "I own this content or have permission to use everything in it, including music, audio, images, names, likenesses, voices, performances, trademarks, third-party clips, and any people appearing in it. I understand Chi'llywood may host, store, stream, display, promote, format, transcode, distribute, moderate, restrict, remove, and monetize this content as described in the Creator Terms.";

export const LIVE_REPLAY_ACKNOWLEDGEMENT =
  "I understand live content, speaker audio/video, chat, replays, and related room metadata may be saved, reviewed, moderated, replayed, or preserved as allowed by Chi'llywood rules and legal requirements.";
...
const contactSections = [
  section("How to Contact Chi'llywood", [
...
const standardChiMayDo = section("What Chi'llywood May Do", [
...
const standardNotResponsible = section("What Chi'llywood Is Not Responsible For", [
...
export const LEGAL_POLICIES = [
  policy({
    ...
    summary: "This policy explains how Chi'llywood collects, uses, shares, retains, and protects information across accounts, Profile, Platform, uploads, Player, Watch-Party, Live, Chi'lly Chat, calls, Premium, support, moderation, legal evidence, diagnostics, and public legal surfaces.",
    sections: [
      section("Plain-English Summary", [
        "Chi'llywood uses information to run the app, keep accounts secure, deliver creator and social video features, operate live rooms and chat calls, process Premium entitlements, respond to support, moderate abuse, handle copyright and legal requests, improve reliability, and comply with law. Some information is visible because users choose public Profile, Platform, upload, live, replay, chat, or discovery settings. Other information is private, restricted by server-side access controls, or available only to support, moderation, legal, and owner/admin tools when there is an allowed reason.",
        "This Privacy Policy is written for a user-generated video and live social platform. It covers data users provide, data created by app activity, data from devices and infrastructure, information from service providers, and records that may be preserved for safety, fraud, billing, copyright, legal holds, evidence exports, or audit requirements. Chi'llywood does not say here that it sells personal information. If future advertising or data-sharing practices require new disclosures, the policy must be updated before those practices are used.",
      ]),
      ...
      section("Information Created by Use of the Service", [
        "Chi'llywood may collect Profile visits, Platform interactions, Player interactions, search and discovery activity, follows or audience relationships, watch-party room membership, live room membership, playback state, chat thread membership, notification preferences, push notification identifiers, device permission state, support and moderation history, report status, legal hold status, evidence export metadata, audit records, and administrative action records. Some activity is retained in aggregated or diagnostic form even when a user later deletes public content.",
        "Device and technical information may include device type, operating system, app version, release build, runtime configuration, crash reports, performance traces, network state, IP-derived operational signals, route names, feature availability, timing measurements, and errors. Approved crash, performance, app infrastructure, live-media, entitlement, billing, and similar providers may help Chi'llywood understand whether the service is working and whether abuse, fraud, or unauthorized access occurred.",
      ]),
      section("Payments, Premium, and Entitlements", [
        "When Premium or subscriptions are available, Google Play, Apple, RevenueCat, approved app infrastructure providers, or other approved providers may process purchase, renewal, cancellation, refund, restore, entitlement, offer, transaction, receipt, and billing-support information. Chi'llywood uses that information to decide whether a normal user has paid access to gated features. Owner Platform access is a separate server-side role exception for the invisible Platform owner account; it is not a fake entitlement and it does not weaken Premium gates for normal users.",
        "Do not send full payment card numbers, app-store passwords, private wallet keys, or unrelated financial data to support. Chi'llywood support may ask for limited purchase identifiers, store account context, screenshots with sensitive details removed, or RevenueCat/app-store identifiers when needed to troubleshoot billing. Store-managed subscriptions may remain active until canceled through the store or billing provider, even if a Chi'llywood account is scheduled for deletion.",
      ]),
      section("How Information Is Used", [
        "Chi'llywood uses information to create and authenticate accounts, provide Profile and Platform surfaces, host creator uploads, operate Player and discovery, run Watch-Party and Live features, deliver Chi'lly Chat and calls, send notifications, manage Premium, process reports, respond to support, handle copyright notices, investigate safety concerns, enforce rules, protect minors and vulnerable people, prevent fraud, maintain backups, investigate crashes, improve performance, and comply with law.",
        "Chi'llywood may also use content and metadata to show uploads in feeds, search, discovery, Profile, Platform, Player, spectator, live, replay, web, CTV, notification, recommendation, admin, moderation, support, and legal surfaces according to policy, visibility, licensing, and server-side access rules. Operational use may include thumbnails, previews, compression, transcoding, captions, excerpts, abuse detection, evidence packages, and legal holds where allowed.",
      ]),
  ...
  policy({
    ...
    path: "/terms",
    title: "Terms of Use",
    summary: "These Terms govern use of Chi'llywood accounts, Profile, Platform, creator uploads, Player, Watch-Party, Live, Chi'lly Chat, calls, Premium, support, reporting, moderation, legal processes, and related services.",
    sections: [
      section("Plain-English Summary", [
        "Chi'llywood is a user-generated video, live, watch-party, chat, and creator platform. Users must be adults, use truthful account information, respect other people, own or have permission for content they upload or stream, follow safety rules, and accept that Chi'llywood may moderate, remove, preserve, or restrict content and accounts when needed. The platform can change features, cannot promise uninterrupted service, and does not promise creators automatic payment.",
        "Creators keep ownership of the content they own. By making content available on Chi'llywood, they grant Chi'llywood the broad operational license needed to host, store, cache, back up, stream, reproduce, display, publicly perform, distribute, publish, transmit, transcode, compress, resize, crop, format-shift, create thumbnails, create previews, create captions or metadata, moderate, restrict, remove, promote, advertise, and monetize the service around or with the content unless a separate agreement says otherwise.",
      ]),
      section("Eligibility and Accounts", [
        "You must be at least 18 years old, legally able to agree to these Terms, and not barred from using the service by law or by a previous Chi'llywood restriction. You are responsible for your account credentials, email access, Profile identity, Platform identity, subscription status, device security, and all activity that occurs under your account. If you represent a business, creator team, agency, or other organization, you represent that you have authority to bind that organization.",
      ...
      section("User Content and License to Chi'llywood", [
        "You retain ownership and copyright in content you create and own. Chi'llywood does not own creator content simply because it is uploaded, posted, livestreamed, commented, sent, shared, or otherwise made available on the service. However, Chi'llywood needs a license to operate the service. By making content available, you grant Chi'llywood a worldwide, non-exclusive, royalty-free, sublicensable, transferable license to use that content as needed to operate, provide, improve, promote, protect, moderate, distribute, monetize, and display Chi'llywood.",
  ...
  policy({
    ...
    summary: "These guidelines explain what behavior and content are allowed on Chi'llywood, how users can report abuse, and what enforcement actions may happen when rules are broken.",
    sections: [
      section("Plain-English Summary", [
        "Chi'llywood is for adult viewers and creators who want social streaming, creator Platforms, live rooms, watch parties, chat, and calls without harassment, theft, exploitation, or unsafe conduct. Be honest about who you are, use content you have rights to use, respect other people, and do not abuse live, chat, reporting, support, billing, or moderation tools. If content or behavior creates risk, Chi'llywood may remove it, restrict it, preserve it, or take account action.",
      ...
      section("Child Safety, Sexual Content, and Consent", [
        "Chi'llywood does not allow sexual exploitation, child sexual abuse material, grooming, sextortion, sexualization of minors, solicitation involving minors, or attempts to move minors into unsafe contact. Users must be adults. If Chi'llywood identifies minor-safety risk, it may restrict accounts, preserve records, report where appropriate, and cooperate with lawful authorities. Users should contact emergency services for immediate danger.",
      ...
      section("Violence, Self-Harm, Dangerous Acts, and Illegal Activity", [
        "Do not credibly threaten, encourage, organize, praise, or instruct serious violence, terrorism, human trafficking, exploitation, animal cruelty, weapon misuse, dangerous challenges, or criminal activity. Graphic or shocking material may be removed or restricted even if posted as commentary if it creates safety, legal, or community risk. Do not use Chi'llywood to sell illegal goods, coordinate illegal services, or evade law enforcement.",
        "Do not encourage self-harm, suicide, eating-disorder behavior, or dangerous behavior. Supportive discussion and recovery-focused content may be allowed when it does not instruct, glamorize, or pressure harm. Chi'llywood is not a crisis service. If someone appears in immediate danger, contact local emergency services or a qualified crisis resource first.",
      ]),
      section("Scams, Fraud, Spam, Impersonation, and Platform Abuse", [
        "Do not run scams, phishing, fake giveaways, fake Premium offers, fake creator payouts, fake investment schemes, malware, credential theft, deceptive downloads, bot networks, fake engagement, spam, or manipulative links. Do not misrepresent yourself as Chi'llywood staff, law enforcement, a sponsor, a creator, a moderator, a rights holder, a public official, a brand, or another user. Official or owner accounts may have protected behavior that ordinary users cannot claim.",
      ...
      section("Live Room, Watch-Party, Chat, and Call Behavior", [
        ...
        "Watch-Party features must not be used to bypass copyright, Premium gates, player restrictions, room permissions, or route ownership. Chat and calls must not be used for spam, threats, stalking, coercion, impersonation, phishing, malware, or harassment. Chi'llywood may mute, remove, block, restrict, end, preserve, or review room and chat activity when product rules or legal obligations allow.",
      ]),
      section("Reporting, Blocking, Enforcement, and Appeals", [
        "Users should report content or behavior that appears abusive, unsafe, infringing, fraudulent, or unlawful. Reporting does not guarantee a specific result, but it helps Chi'llywood prioritize review. Users can also block, leave rooms, decline calls, change settings, contact support, or contact emergency services when appropriate. Abuse of reporting tools can itself lead to enforcement.",
  ...
  policy({
    ...
    summary: "These Creator Terms explain creator ownership, Chi'llywood's content license, upload and live responsibilities, monetization limits, sponsorship rules, deletion effects, and enforcement.",
    sections: [
      section("Plain-English Summary", [
        "Creators keep ownership and copyright in content they create and own. Uploading to Chi'llywood does not transfer ownership to Chi'llywood. But creators must give Chi'llywood the license needed to run a social video platform. That license is broad because the service needs to host, store, stream, transcode, display, promote, moderate, recommend, preserve, and sometimes monetize around content across mobile, web, live, replay, support, moderation, and legal surfaces.",
        "Creators are responsible for rights clearance, accurate metadata, lawful conduct, community safety, sponsorship disclosures, and audience interactions. Uploading content does not automatically create a right to payment. Creator payments require a separate monetization program, revenue-share program, sponsorship agreement, subscription-share program, or written contract. Chi'llywood may monetize the service around content unless a separate agreement says otherwise.",
      ]),
      section("Creator Ownership and Chi'llywood License", [
        "Creators retain ownership and copyright in the content they create and own. Chi'llywood does not own creator content merely because it is uploaded, posted, livestreamed, commented, sent, shared, saved, replayed, or otherwise made available on the service. Creators may still use their own content elsewhere, subject to any separate contracts they make and the rights of other people or rights holders.",
        "By uploading, posting, publishing, livestreaming, commenting, sending, sharing, or otherwise making content available on Chi'llywood, the creator grants Chi'llywood a worldwide, non-exclusive, royalty-free, sublicensable, transferable license to use that content as needed to operate, provide, improve, promote, protect, moderate, distribute, monetize, and display the Chi'llywood service. This license lasts for as long as needed for those purposes, subject to deletion, retention, legal hold, and applicable law.",
      ]),
      section("Specific Rights Included in the License", [
        ...
        "The license also lets Chi'llywood make technical, editorial, safety, accessibility, discovery, and operational adjustments that do not change creator ownership. Examples include video processing, thumbnail selection, aspect-ratio formatting, previews, captions, indexing, recommendation metadata, moderation labels, geoblocking, age restriction, takedown handling, security review, evidence preservation, and showing content in app-store or public marketing materials for the service unless a separate written agreement limits those promotional uses.",
      ]),
      ...
      section("Upload, Publish, Go-Live, and Replay Acknowledgements", [
        "Before upload, publish, go-live, or replay-save flows, Chi'llywood may require creators to confirm: I own this content or have permission to use everything in it, including music, audio, images, names, likenesses, voices, performances, trademarks, third-party clips, and any people appearing in it. I understand Chi'llywood may host, store, stream, display, promote, format, transcode, distribute, moderate, restrict, remove, and monetize this content as described in the Creator Terms.",
        "For live and replay-enabled features, Chi'llywood may also require creators to confirm: I understand live content, speaker audio/video, chat, replays, and related room metadata may be saved, reviewed, moderated, replayed, or preserved as allowed by Chi'llywood rules and legal requirements. These confirmations are creator-facing reminders. They do not replace the full Terms, do not prove rights clearance, and do not prevent enforcement.",
      ]),
      section("Creator Payment and Monetization Limits", [
        "Uploading, publishing, streaming, joining a live room, receiving views, gaining followers, being featured, creating replays, or appearing in discovery does not automatically entitle a creator to payment. Chi'llywood may monetize the service, pages, players, live rooms, feeds, discovery, ads, subscriptions, promotions, CTV, replays, or other surfaces. Creators are paid only if a separate Chi'llywood monetization program, subscription-share program, ad-share program, sponsorship agreement, or written contract applies.",
        "No automatic revenue share is promised unless backed by written product/legal terms. Creator earnings, if later enabled, may depend on eligibility, identity verification, tax forms, payment provider approval, supported country, minimum thresholds, fraud review, rights clearance, safety status, account standing, chargebacks, refunds, provider restrictions, sanctions screening, and policy compliance. Chi'llywood may withhold, reverse, delay, or deny payouts where allowed by law and contract.",
      ]),
      section("Sponsorships, Promotions, and AI or Generated Content", [
        "Creators must clearly disclose paid, gifted, affiliate, discounted, commissioned, or otherwise compensated promotions. Disclosures should be easy to see, near the endorsement, and understandable to ordinary users. Do not claim fake sponsorships, hide material connections, misrepresent products, make unsubstantiated claims, promote unsafe goods, or use Chi'llywood to run deceptive offers. Creators are responsible for compliance with endorsement, advertising, consumer-protection, and platform rules.",
        "If creators use AI-generated or AI-assisted content, synthetic voices, deepfakes, avatars, cloned likenesses, generated music, or generated images, they remain responsible for rights, consent, safety, authenticity, disclosures, and compliance. AI tools do not guarantee non-infringement or permission to use a person's likeness, voice, performance, style, trademark, or copyrighted work. Chi'llywood may label, restrict, remove, or require disclosure for generated or manipulated content.",
      ]),
      section("Deletion, Removal, and Retention", [
        ...
        "Chi'llywood may also remove, restrict, block, disable, demonetize, age-restrict, geoblock, preserve, or review content for copyright/IP complaints, DMCA notices, legal requests, court orders, law enforcement, safety, community rules, fraud, security, child safety, harassment, threats, platform integrity, account violations, repeat infringement, spam, scams, impersonation, privacy complaints, or publicity complaints. Creator ownership does not require Chi'llywood to keep hosting content.",
      ]),
    ],
  }),
  policy({
    ...
    summary: "This policy explains Chi'llywood's copyright rules, takedown notices, counter-notices, repeat infringer handling, preservation during disputes, and owner/admin DMCA launch checklist.",
    sections: [
      section("Plain-English Summary", [
        "Chi'llywood respects copyright owners, creators, lawful users, and fair-process expectations. Users must not upload, stream, replay, post, message, or share content they do not own or have permission to use. Copyright owners can send takedown notices. Affected users can submit counter-notices when they believe content was removed by mistake or misidentification. Chi'llywood may remove or disable content, preserve records, track strikes, restrict accounts, or terminate repeat infringers.",
        "This policy is designed to support DMCA-style operations, but it is not legal advice and does not by itself guarantee safe-harbor protection. Chi'llywood must maintain a current designated agent, public contact information, a repeat infringer policy, proper notice and counter-notice handling, and legally reviewed operations before relying on any legal safe harbor.",
      ]),
      ...
      section("Copyright Owner Takedown Notice Requirements", [
        "A copyright owner or authorized agent who believes content on Chi'llywood infringes copyright should use the public copyright report form at https://chillywoodstream.com/copyright-report or send a notice with enough information for Chi'llywood to evaluate and locate the material. The notice should include the claimant's full legal name, organization if applicable, contact email, mailing address, phone number if available, identification of the copyrighted work, identification of the allegedly infringing content or URL/route/id, and enough detail to find it in the app.",
      ...
      section("Where to Send Notices and Designated Agent", [
        "Copyright notices should be sent to Chi'llywood Copyright Agent / Chi'llywood at support@chillywoodstream.com unless a later public page names a different agent address. Current public records in the repo mention Chi'llywood Copyright Agent / Chi'llywood, support@chillywoodstream.com, 9316 S Kimbark, Chicago, IL 60619, phone 3124879454, and DMCA registration number DMCA-1072720. These details must be verified and kept current before public launch.",
  ...
  policy({
    ...
    summary: "This policy explains how users can get account, Premium, creator, moderation, copyright, legal, account deletion, and safety help from Chi'llywood Support.",
    sections: [
      section("Plain-English Summary", [
        "Chi'llywood Support helps route account, password, Profile, Platform, Premium, creator upload, live, chat, safety, copyright, moderation, legal, account deletion, and reliability issues. Support can collect context, ask for verification, open internal review, explain known policy paths, and help users understand what to do next. Support cannot guarantee immediate response, legal advice, app-store refunds, content restoration, account restoration, or emergency response.",
      ...
      section("Premium and Billing Support", [
        ...
        "Users should not send full card numbers, app-store passwords, or bank credentials. Support may ask for order ids, store transaction ids, RevenueCat identifiers, entitlement status screenshots, device platform, and the signed-in Chi'llywood account. Chi'llywood does not promise a refund, permanent feature availability, or uninterrupted Premium access beyond applicable law and provider terms.",
      ]),
      ...
      section("Moderation, Appeals, and Safety Support", [
        ...
        "Support may not disclose enforcement details about other users. Appeals may be available for certain moderation decisions, but not every decision has a guaranteed appeal path or deadline. Severe safety, child-safety, credible threat, exploitation, copyright, legal hold, or fraud issues may override ordinary support timing. Chi'llywood is not an emergency service; users should contact emergency services when immediate danger exists.",
      ]),
      ...
      section("Response Expectations and Boundaries", [
        "Response time depends on support capacity, issue type, safety priority, account verification, legal complexity, copyright process, and product reliability. Chi'llywood may prioritize child safety, credible threats, active scams, account compromise, legal process, severe harassment, and service outages. Routine product questions, feature requests, and non-urgent billing questions may take longer.",
  ...
  policy({
    ...
    summary: "This policy explains how users can delete a Chi'llywood account, restore it within 30 days, what may be deleted or de-identified, what may be retained, and how deletion interacts with subscriptions, backups, legal holds, and Google Play requirements.",
    sections: [
      section("Plain-English Summary", [
      ...
      section("Legal Holds, Evidence, and Safety Exceptions", [
        "Chi'llywood may place a legal hold when data is relevant to law enforcement, legal request, court order, subpoena, preservation request, safety incident, copyright dispute, moderation case, fraud investigation, billing dispute, or other legal obligation. A legal hold can delay deletion of relevant records. Users may be told where appropriate, but notice may be limited by law, safety, or investigation needs.",
        "The Legal Evidence tool is read-only for evidence packages and should not delete evidence. Account deletion should not be used to destroy evidence, evade moderation, hide infringement, avoid chargebacks, or frustrate lawful process. Chi'llywood may preserve audit rows and evidence export records even after account deletion.",
      ]),
  ...
  policy({
    ...
    sections: [
      ...
      section("Premium Features and Availability", [
        ...
        "Chi'llywood may add, remove, rename, limit, replace, or change Premium features where allowed by law and store/provider rules. If a paid feature materially changes, Chi'llywood should update product copy and support guidance. Premium does not guarantee uninterrupted live service, perfect playback, error-free chat, specific creator content, permanent rooms, or access to content that is removed for policy, legal, copyright, or safety reasons.",
      ]),
      section("Billing Providers and Entitlement Source of Truth", [
        "Normal user Premium status may be processed through Google Play, Apple, RevenueCat, app entitlement records, or another approved provider. The provider may control price display, taxes, renewal timing, cancellation path, refunds, trials, receipts, and subscription management. Chi'llywood uses verified entitlement status to decide whether normal users clear Premium gates. Users should be signed into the correct store account and Chi'llywood account when purchasing or restoring.",
      ...
      section("Cancellations, Refunds, Failed Payments, and Restores", [
        "Users can usually cancel subscriptions through the app store or billing provider used for purchase. Deleting the Chi'llywood app or account may not cancel a store-managed subscription. Refunds may be controlled by the store, provider, or applicable law. Chi'llywood does not promise a refund outside those rules. If payment fails, access may end, enter a grace period, or resume after payment is fixed, depending on provider status.",
        "Restore purchase flows may help link active provider entitlements to the current account, but restore cannot create Premium where no valid purchase exists. Users may need to use the same store account, device platform, or Chi'llywood account. Support can help troubleshoot restore issues but cannot expose provider secrets or bypass entitlement verification.",
      ]),
      ...
      section("Creator Tools and No Revenue Guarantee", [
        ...
        "Creator payments require a separate monetization program, written agreement, or product terms. Chi'llywood may monetize the service, pages, players, live rooms, feeds, discovery, ads, subscriptions, promotions, CTV, replays, or other surfaces. If creators are paid later, eligibility may depend on identity verification, tax forms, provider approval, fraud review, rights clearance, minimum thresholds, account standing, safety compliance, and supported regions.",
      ]),
      section("Restrictions and Abuse", [
        "Users may not share Premium access unlawfully, resell accounts, manipulate subscriptions, abuse trials, exploit refund systems, fake receipts, bypass gates, use stolen payment methods, reverse engineer billing, or misrepresent entitlement status. Chi'llywood may restrict access, preserve records, terminate accounts, or report fraud where appropriate.",
  ...
  policy({
    ...
    sections: [
      ...
      section("Camera, Microphone, Consent, and Replays", [
        "Participants should understand that using camera, microphone, speaker roles, live chat, or replay-enabled features can expose their voice, likeness, image, statements, room metadata, and participation to other users and potentially to moderation, support, legal, or replay surfaces. If a feature can save replays or room metadata, Chi'llywood may preserve or review that material as allowed by rules and law.",
      ...
      section("Chat, Calls, and Messaging Conduct", [
        ...
        "Call participants are responsible for what they say and show. Caller and callee should respect consent, device permissions, recording rules, and privacy. Chi'llywood may preserve call metadata, room identifiers, support reports, and legal evidence where allowed. Chi'llywood does not promise that every call will connect or that all network/device issues can be fixed immediately.",
      ]),
      section("Moderation, Removal, and Live Safety", [
        "Chi'llywood may mute, remove, block, restrict, end, preserve, review, or prevent access to live, watch-party, chat, call, replay, and room features for safety, copyright, legal, Premium, fraud, security, child-safety, harassment, threats, platform integrity, reliability, or policy reasons. Users should report unsafe rooms and leave when needed. Support is not an emergency service.",
        "Live content can move quickly. Chi'llywood may not review every live statement before it appears. Users and hosts remain responsible for live conduct. Severe live harm, child-safety risk, credible threats, exploitation, illegal activity, or copyright abuse may lead to immediate restrictions and record preservation.",
      ]),
      section("Technical Reliability and Live Ops", [
        "Live and call reliability can be affected by room access, signaling, relay paths, cellular networks, device permissions, app behavior, camera state, microphone state, subscriptions, media provider capacity, and app versions. Chi'llywood may run Owner/Admin Live Ops checks, dry-run incidents, and approved remediation workflows, but real production actions require owner/operator approval and must not fake health.",
        "Users should not interpret a failed join, blank feed, low relay bytes, black screen, audio-only failure, or ended room as confirmation of a legal or moderation decision. Reliability incidents may be diagnosed separately from policy enforcement. Chi'llywood may preserve logs and incident records to troubleshoot reliability.",
      ]),
    ],
  }),
  policy({
    ...
    summary: "This policy explains how Chi'llywood handles law-enforcement requests, preservation requests, subpoenas, warrants, court orders, emergency disclosures, legal holds, user notice, and evidence exports.",
    sections: [
      section("Plain-English Summary", [
        "Chi'llywood does not casually disclose private user data. Law-enforcement, government, civil legal, and rights-holder requests must go through a controlled legal request process. Requesters should provide agency or party identity, legal authority, case number, target identifiers, date range, requested records, and contact details. Chi'llywood may require valid legal process, preserve data, notify users where allowed, deny overbroad or informal requests, and audit access and exports.",
        "Emergency requests involving imminent risk of death or serious physical harm may be handled faster if enough information is provided. Chi'llywood may disclose limited information in emergencies where legally permitted and where the facts support the request. The Legal Evidence tool is read-only for previews, exports, and holds; it must not be used to delete evidence.",
      ]),
      section("Who May Submit and What Must Be Included", [
        ...
        "Informal messages, vague requests, screenshots without legal authority, or requests for broad browsing of private user data may be denied or require clarification. Chi'llywood may ask for a subpoena, warrant, court order, consent, or other lawful process depending on the type of data and jurisdiction. Requesters should not ask support staff to bypass legal workflow or send secrets.",
      ]),
      section("Preservation Requests and Legal Holds", [
        "A preservation request asks Chi'llywood to preserve specified records while legal process is obtained. Requests should identify the target account/content/room/thread/report, the date range, the agency or case, the legal basis, and the expiration or follow-up timeline. Chi'llywood may place a legal hold to prevent deletion of relevant data, preserve metadata, and record the request in legal intake systems.",
        "Preservation does not guarantee disclosure. It means relevant data may be retained while the requester obtains proper process or while Chi'llywood evaluates legal obligations. Users may not use account deletion, content deletion, or support requests to destroy evidence under legal hold. Legal holds should be reviewed and released only under an approved retention process.",
      ]),
      section("Subpoenas, Warrants, Court Orders, and Civil Requests", [
        "Chi'llywood may require different legal process depending on the data requested. Basic subscriber or account records, content records, message content, private communications, precise metadata, payment data, or sensitive legal evidence may require different authority. Chi'llywood may challenge, narrow, or reject requests that are invalid, overbroad, inconsistent, improperly served, outside jurisdiction, missing identifiers, or seeking unrelated private data.",
        "Civil litigants should not expect informal disclosure. Chi'llywood may require valid subpoena or court order and may give user notice where allowed. Rights holders should use the Copyright/DMCA process for copyright takedown matters and legal process for broader private-data requests. International requests may require mutual legal assistance or other valid cross-border process.",
      ]),
      section("Emergency Disclosure Policy", [
        "If a request involves imminent risk of death, serious physical injury, child exploitation, kidnapping, active violence, or comparable emergency, the requester should clearly mark it as an emergency, explain the facts, identify the person at risk, identify the target account or content, explain what information is needed, and provide official contact details. Chi'llywood may verify the requester before acting where time allows.",
        "Emergency disclosure is limited to information Chi'llywood reasonably believes is necessary to address the emergency and legally permitted to disclose. Emergency review does not create a general support shortcut. False emergency requests may be rejected and may have legal consequences.",
      ]),
      section("User Notice and Transparency", [
        "Chi'llywood may notify affected users about legal requests where legally allowed and appropriate. Notice may be delayed or withheld if prohibited by law, court order, safety concerns, child-safety concerns, investigation needs, risk of evidence destruction, or other lawful reason. Chi'llywood may ask requesters to identify any non-disclosure requirement.",
        "Chi'llywood may publish transparency information in the future, but this policy does not promise a public report. Internal legal request intake, review status, evidence preview, export, and legal hold actions should be recorded so the owner or authorized legal reviewer can understand who handled the request and why.",
      ]),
  ...
  policy({
    ...
    sections: [
      section("Plain-English Summary", [
        ...
        "Users can report abuse and may appeal certain decisions through support where supported. Appeals do not guarantee restoration. Chi'llywood may preserve evidence, logs, and audit records during moderation and legal review. Admins need scoped permissions for sensitive access. Owner normal use follows owner rules and is not audited unless Break Glass is active.",
      ]),
      ...
      section("Repeat Violations and Evasion", [
        ...
        "Chi'llywood may retain enforcement records to detect repeat violations and prevent banned or dangerous users from returning. Those records may survive account deletion where legally and operationally justified. Users should not interpret a lack of immediate action as permission to continue borderline conduct.",
      ]),
  ...
  policy({
    ...
    sections: [
      ...
      section("Eligibility and Compliance", [
        ...
        "Chi'llywood may deny, pause, withhold, reverse, delay, or forfeit payments where allowed by law and contract for fraud, chargebacks, refunds, invalid activity, sanctions, provider restrictions, account compromise, copyright disputes, legal holds, tax issues, missing forms, policy violations, deceptive sponsorships, fake engagement, or unsafe content.",
      ]),
      section("Sponsorships and Paid Promotions", [
        ...
        "Chi'llywood may remove, restrict, demonetize, or require changes to undisclosed or misleading sponsorships, unsafe product promotions, fake offers, illegal goods, deceptive affiliate links, or ads that violate law, app-store policy, provider rules, or platform policy. Sponsors do not control moderation or legal decisions unless a written agreement and applicable law say otherwise.",
      ]),
      section("Taxes, Payment Providers, and Disputes", [
        "Creators are responsible for taxes, reporting, forms, payment-account accuracy, and compliance with laws that apply to their earnings. Payment providers may require identity, bank, tax, sanctions, fraud, and compliance checks. Chi'llywood may issue forms where legally required but does not provide tax advice. Creators should consult their own advisors.",
        "Payment disputes should be submitted through the applicable program support path with account id, period, payment id, and a concise explanation. Chi'llywood may review logs, provider records, fraud signals, rights disputes, and policy status. No payment dispute should be used to demand disclosure of private user data, service secrets, or unrelated creator metrics.",
      ]),
      section("No Guarantee of Audience or Revenue", [
        "Chi'llywood does not guarantee that creators will receive views, subscribers, followers, watch time, comments, likes, recommendations, sponsorships, ad fill, CPM, conversion, tips, sales, payout eligibility, or revenue. Algorithms, search, discovery, player placement, live rooms, recommendations, public Platforms, Premium surfaces, and ads may change at any time.",
        "Creators should not present Chi'llywood as guaranteed income, guaranteed sponsorship access, guaranteed audience growth, or guaranteed revenue share. Misleading financial claims, fake analytics, manipulated metrics, or scams can lead to enforcement, demonetization, termination, and legal review.",
      ]),
    ],
  }),
];
