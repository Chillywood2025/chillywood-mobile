  ...
  policy({
    ...
    sections: [
      ...
      section("How to Request Deletion In App", [
        ...
        "Include the account email, user id if visible, Profile or Platform identifiers, and any context needed to identify the account. Do not send passwords or reset links. Chi'llwood may reply to verify account ownership, ask follow-up questions, explain subscription cancellation, confirm whether legal holds exist, or provide timing expectations. Requests made from an unrelated email may require extra verification or may be denied.",
      ]),
