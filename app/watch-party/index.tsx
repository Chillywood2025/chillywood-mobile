...
const styles = StyleSheet.create({
  ...
  headerCopy: { flex: 1 },
  kicker: { color: CHILLYWOOD_VISUAL.textMuted, fontSize: 10, fontWeight: "900", letterSpacing: 1.8 },
  headline: { color: "#fff", fontSize: 38, fontWeight: "900", marginTop: 4, lineHeight: 42 },
  tagline: { color: CHILLYWOOD_VISUAL.textMuted, fontSize: 14, lineHeight: 20 },
  ...
  presenceKicker: { color: CHILLYWOOD_VISUAL.textMuted, fontSize: 9.5, fontWeight: "900", letterSpacing: 1.1 },
  ...
  presenceCodePill: {
    ...
    backgroundColor: "rgba(110,33,255,0.18)",
  ...
  roomIdentityLabel: { color: CHILLYWOOD_VISUAL.textMuted, fontSize: 9.5, fontWeight: "900", letterSpacing: 1.1 },
  ...
  peopleLabel: { color: CHILLYWOOD_VISUAL.textMuted, fontSize: 9.5, fontWeight: "900", letterSpacing: 1.1 },
  ...
  inviteMeta: { gap: 5 },
  inviteLabel: { color: CHILLYWOOD_VISUAL.textMuted, fontSize: 9.5, fontWeight: "900", letterSpacing: 1.1 },
  ...
  actionAreaLabel: { color: CHILLYWOOD_VISUAL.textMuted, fontSize: 9.5, fontWeight: "900", letterSpacing: 1.1 },
