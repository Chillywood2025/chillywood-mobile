  ...
  return (
    ...
    >
      ...
      <LegalSection title="2. Copyright Reports">
        <LegalParagraph>
          If you believe content on Chi&apos;llywood infringes your copyright, send a notice to Chi&apos;llywood Support with enough information for review.
        </LegalParagraph>
        <LegalList
          items={[
      ...
      <LegalSection title="3. Where to Send Notices">
        <LegalParagraph>Copyright and DMCA notices should be sent to:</LegalParagraph>
      ...
      <LegalSection title="6. No Fake Clearance">
        <LegalParagraph>
