...
- Admin Usage Metering Foundations 37-39 is pushed as local schema/helper/read-only Admin foundation. Remote migration application, generated type refresh, real bandwidth/provider logs, LiveKit billing truth, storage billing truth, event writers, revenue ledger, payout ledger, network invoices, sponsor deals, and fraud holds remain later separately scoped lanes.
